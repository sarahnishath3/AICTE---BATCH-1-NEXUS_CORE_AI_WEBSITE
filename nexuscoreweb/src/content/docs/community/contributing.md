---
title: Contributing to Nexus Core
description: Complete guide for contributing to Nexus Core - branch workflow, development setup, testing, coding standards, and pull request process
section: community
order: 1
---
...
First off, thank you for considering contributing to Nexus Core! It's people like you that make Nexus Core such a great tool.
...
2. Run `nexus-core scrape --config configs/test.json`
3. See error
...
Thank you for contributing to Nexus Core! 🎉
