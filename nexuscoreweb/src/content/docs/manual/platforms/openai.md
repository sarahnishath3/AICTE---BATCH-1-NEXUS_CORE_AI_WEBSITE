...
Complete guide for creating and deploying skills to OpenAI ChatGPT using Nexus Core.

## Overview

Nexus Core packages documentation into OpenAI-compatible formats optimized for:
...
# NOT:
nexus-core package output/react/ --target gemini  # Creates .tar.gz
```
...
1. ✅ Install OpenAI support: `pip install nexus-core[openai]`
