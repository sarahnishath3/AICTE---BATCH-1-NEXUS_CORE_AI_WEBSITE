...
Complete guide for creating and deploying skills to Google Gemini using Nexus Core.

## Overview

Nexus Core packages documentation into Gemini-compatible formats optimized for:
...
# NOT:
nexus-core package output/react/  # Creates .zip (Claude format)
```
...
1. ✅ Install Gemini support: `pip install nexus-core[gemini]`
