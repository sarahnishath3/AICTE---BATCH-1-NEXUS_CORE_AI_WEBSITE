...
description: Common issues and solutions when using Nexus Core - installation, runtime, MCP setup, and platform-specific fixes
section: guides
order: 1
---
...
- [MCP Setup Guide](/docs/guides/mcp-setup) - Set up MCP integration
