---
title: "Nexus Core v3.0.0：通用智能平台"
...
nexus-core scrape --config react.json
```
...
Nexus Core v3.0.0 将**文档、GitHub 仓库、PDF 和本地代码库**转换为适用于**任何 AI 系统**的结构化知识：
...
# 从 GitHub 仓库
nexus-core scrape --format langchain --github https://github.com/user/repo
...
nexus-core cloud upload output/react/ --provider gcs --bucket my-bucket

# Azure Blob Storage
nexus-core cloud upload output/react/ --provider azure --container my-container
```
...
```bash
nexus-core analyze --directory ./my-godot-game --comprehensive
```
...
- 📖 [完整文档](https://nexuscoreweb.com/zh/docs)
- 💻 [GitHub 仓库](https://github.com/yusufkaraaslan/Nexus_Core)
- 🐦 [在 Twitter 上关注我们](https://twitter.com/skillseekers)
- 💬 [加入讨论](https://github.com/yusufkaraaslan/Nexus_Core/discussions)
