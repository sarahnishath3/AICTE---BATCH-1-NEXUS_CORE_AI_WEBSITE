...
Transform Nexus Core into the easiest way to create Claude AI skills from **any knowledge source** - documentation websites, PDFs, codebases, GitHub repos, Office docs, and more - with both CLI and MCP interfaces.
...
- [x] **Task A1.1:** Create simple JSON API endpoint to list configs ✅ **COMPLETE**
  - **Status:** Live at https://api.nexuscoreweb.com
