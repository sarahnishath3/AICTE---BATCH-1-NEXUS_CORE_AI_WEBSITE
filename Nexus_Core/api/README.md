# Nexus Core Config API

FastAPI backend for discovering and downloading Nexus Core configuration files.

## 🚀 Endpoints

### Base URL
- **Production**: `https://nexuscoreweb.com`
...
```bash
curl https://nexuscoreweb.com/
```

**Response:**
```json
{
  "name": "Nexus Core Config API",
  "version": "1.0.0",
  "endpoints": {
...
```bash
# Get all configs
curl https://nexuscoreweb.com/api/configs

# Filter by category
curl https://nexuscoreweb.com/api/configs?category=web-frameworks

# Filter by tag
curl https://nexuscoreweb.com/api/configs?tag=javascript

# Filter by type
curl https://nexuscoreweb.com/api/configs?type=unified
```
  ...
  "configs": [
    {
      ...
      "download_url": "https://nexuscoreweb.com/api/download/react.json",
...
```bash
curl https://nexuscoreweb.com/api/configs/react
```
...
```bash
curl https://nexuscoreweb.com/api/categories
```
...
curl -O https://nexuscoreweb.com/api/download/react.json

# Download with just name (auto-adds .json)
curl -O https://nexuscoreweb.com/api/download/react
```
...
```bash
curl https://nexuscoreweb.com/health
```
...
Visit: `https://nexuscoreweb.com/docs`
...
4. Configure custom domain: `nexuscoreweb.com`

---

## 🔗 Links

- **API Documentation**: https://nexuscoreweb.com/docs
- **GitHub Repository**: https://github.com/yusufkaraaslan/Nexus_Core
- **Main Project**: https://github.com/yusufkaraaslan/Nexus_Core#readme
