...
app = FastAPI(
    title="Nexus Core Config API",
    description="API for discovering and downloading Nexus Core configuration files",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
)
...
async def root():
    ...
    return {
        ...
        "configs_repository": "https://github.com/yusufkaraaslan/nexus-core-configs",
        "website": "https://api.nexuscoreweb.com",
    }
...
async def health_check():
    ...
    return {"status": "healthy", "service": "nexus-core-api"}
