# Nexus Core — Smithery MCP Registry

Publishing guide for the Nexus Core MCP server on [Smithery](https://smithery.ai).

## Status

- **Namespace created:** `yusufkaraaslan`
- **Server created:** `yusufkaraaslan/nexus-core`
- **Server page:** https://smithery.ai/servers/yusufkaraaslan/nexus-core
...
1. Go to https://smithery.ai/servers/yusufkaraaslan/nexus-core/releases
...
1. Deploy the MCP server on Render/Railway/Fly.io:
   ...
   docker build -f Dockerfile.mcp -t nexus-core-mcp .
...
**Display name:** Nexus Core — AI Skill & RAG Toolkit
...
smithery mcp add yusufkaraaslan/nexus-core --client claude

# Or configure manually — users need nexus-core installed:
