#!/usr/bin/env python3
"""
Translate Nexus Core documentation to Chinese.
...
def translate_with_anthropic(content: str, api_key: str) -> str:
    ...
    try:
        ...
        system_prompt = """You are a professional technical translator translating Nexus Core documentation from English to Simplified Chinese.
...
def main():
    parser = argparse.ArgumentParser(
        description="Translate Nexus Core documentation to Chinese"
    )
    parser.add_argument(
        "file",
        nargs='?',
