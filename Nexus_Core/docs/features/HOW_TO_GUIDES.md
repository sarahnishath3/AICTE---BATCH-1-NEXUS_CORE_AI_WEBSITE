...
nexus-core create tests/ --output output/codebase/

# Or use the standalone subcommand (writes JSON to stdout)
nexus-core extract-test-examples tests/ --json \
...
nexus-core create tests/ --enhance-level 3
```
...
nexus-core create tests/ --enhance-level 3 --agent claude
```
...
nexus-core create tests/ --enhance-level 0
```
...
nexus-core-how-to-guides examples.json --ai-mode none

# Then enhance only specific guides manually
nexus-core-enhance output/codebase/tutorials/user_management.md
```
...
```bash
# Basic usage
nexus-core-how-to-guides <input-file> [OPTIONS]
...
# Examples
nexus-core-how-to-guides test_examples.json
nexus-core-how-to-guides examples.json --output tutorials/
nexus-core-how-to-guides examples.json --group-by file-path --no-ai
```
...
```python
from nexus_core.cli.how_to_guide_builder import HowToGuideBuilder
...
```bash
nexus-core-how-to-guides examples.json --group-by file-path
```
...
```bash
nexus-core-how-to-guides examples.json --group-by test-name
```
...
```bash
nexus-core-how-to-guides examples.json --group-by complexity
```
...
```bash
nexus-core create /path/to/repo/ --output output/codebase/
```
...
nexus-core-extract-test-examples tests/ --output old-examples.json

# Extract from new version tests
nexus-core-extract-test-examples tests/ --output new-examples.json

# Generate migration guides
nexus-core-how-to-guides old-examples.json --output migration/old/
nexus-core-how-to-guides new-examples.json --output migration/new/
```
...
1. **Disable AI for speed:**
   ```bash
   nexus-core-how-to-guides examples.json --no-ai  # 2x faster
   ```
...
# Coverage report
pytest tests/test_how_to_guide_builder.py --cov=nexus_core.cli.how_to_guide_builder
```
