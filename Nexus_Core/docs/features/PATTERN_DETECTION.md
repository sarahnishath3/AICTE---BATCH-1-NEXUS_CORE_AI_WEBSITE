...
nexus-core create --directory src/
...
**Solutions:**
1. Check file language is supported: `nexus-core-patterns --file test.py --verbose`
...
- **Implementation**: `src/nexus_core/cli/pattern_recognizer.py` (~1,900 lines)
