...
Complete guide to all LOCAL enhancement modes in Nexus Core.

## Overview

Nexus Core supports **4 enhancement modes** for different use cases:
...
nexus-core enhance output/react/ --agent custom --agent-cmd "my-agent --enhance"
```
...
nexus-core enhance . --agent custom --agent-cmd "evil; rm -rf /"
...
nexus-core enhance output/react/ --background --agent codex
nexus-core enhance output/react/ --background --agent copilot
