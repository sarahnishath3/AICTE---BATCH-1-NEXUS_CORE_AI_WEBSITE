...
**Example**:
```bash
nexus-core create --config config.json --merge-mode rule-based
```
...
**Example**:
```bash
nexus-core create --config config.json --merge-mode claude-enhanced
```
...
# Override merge mode
nexus-core create --config configs/react_unified.json --merge-mode claude-enhanced

# Fresh start (clear cached data)
nexus-core create --config configs/react_unified.json --fresh

# Dry run (preview without executing)
nexus-core create --config configs/react_unified.json --dry-run
```
...
nexus-core create --config configs/react_unified.json --enhance-workflow security-focus
...
nexus-core create --config configs/react_unified.json --enhance-level 3

# Provide API key (or use ANTHROPIC_API_KEY env var)
nexus-core create --config configs/react_unified.json --api-key YOUR_API_KEY
```
...
- Documentation: https://github.com/yusufkaraaslan/Nexus_Core/docs
