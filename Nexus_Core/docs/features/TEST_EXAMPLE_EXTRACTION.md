...
- [Pattern Detection (C3.1)](../src/nexus_core/cli/pattern_recognizer.py) - Detect design patterns
- [Codebase Scraper](../src/nexus_core/cli/codebase_scraper.py) - Analyze local repositories
