...
> **Nexus Core v3.6.0**  
> **Understanding how Nexus Core works**

---

## Overview

Nexus Core transforms documentation, code, and content into **structured knowledge assets** that AI systems can use effectively. It supports **18 source types** including documentation sites, GitHub repos, PDFs, videos, notebooks, wikis, and more.

```
Raw Content → Nexus Core → AI-Ready Skill
     ↓                              ↓
...
Nexus Core works with **17 types of sources**:
...
**Command:**
```bash
nexus-core create --conf-base-url https://wiki.example.com --space-key DEV
```
...
**Command:**
```bash
nexus-core create --database-id  abc123
```
...
**Command:**
```bash
nexus-core create --chat-export-path  slack-export/
```
...
nexus-core create <source> --rate-limit 0.1

# Slower (for rate-limited sites)
nexus-core create <source> --rate-limit 2.0
```
