...
nexus-core enhance output/my-skill/ --target claude
```
...
nexus-core enhance output/my-skill/ --agent codex
nexus-core enhance output/my-skill/ --agent copilot
nexus-core enhance output/my-skill/ --agent kimi
nexus-core enhance output/my-skill/ --agent opencode

# Custom agent
nexus-core enhance output/my-skill/ --agent custom --agent-cmd "my-agent {prompt_file}"
```
...
# Maximum enhancement
nexus-core create <source> --enhance-level 3
```
...
# With timeout
nexus-core enhance output/my-skill/ --timeout 1200
```
...
```bash
# Run in background
nexus-core enhance output/my-skill/ --background

# Check status
nexus-core enhance-status output/my-skill/

# Watch in real-time
nexus-core enhance-status output/my-skill/ --watch
```
...
# Use it
nexus-core create <source> --enhance-workflow my-custom
```
...
nexus-core enhance-status output/my-skill/ --json

# Watch mode
nexus-core enhance-status output/my-skill/ --watch --interval 10
```
...
nexus-core enhance output/best-skill/
```
...
# API focus
nexus-core create <source> --enhance-workflow api-documentation
```
...
nexus-core enhance output/my-skill/
# Review again...
nexus-core enhance output/my-skill/  # Run again for more polish
```
