...
**Modified Files:**
- `src/nexus_core/cli/merge_sources.py` (enhanced)
...
**Modified Files:**
- `src/nexus_core/cli/generate_router.py` (enhanced)
...
**Architecture Document**: `/mnt/1ece809a-2821-4f10-aecb-fcdf34760c0b/Git/Nexus_Core/docs/C3_x_Router_Architecture.md`
