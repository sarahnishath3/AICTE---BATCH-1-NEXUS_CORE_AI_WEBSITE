...
**File:** `src/nexus_core/cli/unified_skill_builder.py`
...
**File:** `src/nexus_core/cli/utils.py`
**Lines:** 274-275
...
**Test:**
```bash
nexus-core enhance output/httpx/ --mode local
...
**Test:**
```bash
nexus-core create --config configs/httpx_comprehensive.json
