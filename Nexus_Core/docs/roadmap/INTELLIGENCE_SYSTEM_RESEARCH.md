# Nexus Core Intelligence System - Research Topics
...
**Experiment:**
1. Generate skills at all 3 granularities for nexus-core
...
|---------|-------|------|-------------|-------------|
| nexus-core | 140 | 3 min | 30 sec | ✅ Yes |
...
```bash
# View skill history
nexus-core skill-history api.skill

# Diff versions
nexus-core skill-diff api.skill --from 2026-01-15 --to 2026-01-20

# Rollback
nexus-core skill-rollback api.skill --to 2026-01-19
```
