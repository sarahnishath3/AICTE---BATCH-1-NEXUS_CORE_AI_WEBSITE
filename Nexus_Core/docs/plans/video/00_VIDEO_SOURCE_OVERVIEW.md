...
5. **Completeness** — Nexus Core aims to be the **universal** documentation preprocessor. Video is the last major content type we don't support.
...
1. **Functional:** `nexus-core create https://youtube.com/watch?v=xxx` produces a skill with video content integrated into SKILL.md.
...
6. **Tiered deps:** `pip install nexus-core[video]` works without pulling Whisper/OpenCV.
