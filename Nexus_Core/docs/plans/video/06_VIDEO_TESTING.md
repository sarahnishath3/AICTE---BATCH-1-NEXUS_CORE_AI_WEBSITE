...
class TestYouTubeTranscript:
    @patch('nexus_core.cli.video_transcript.YouTubeTranscriptApi')
...
class TestWhisperTranscription:
    @pytest.mark.slow
    @patch('nexus_core.cli.video_transcript.WhisperModel')
...
class TestOCRExtraction:
    @pytest.mark.slow
    @patch('nexus_core.cli.video_visual.easyocr.Reader')
...
class TestFullPipeline:
    @patch('nexus_core.cli.video_transcript.YouTubeTranscriptApi')
    @patch('nexus_core.cli.video_scraper.YoutubeDL')
