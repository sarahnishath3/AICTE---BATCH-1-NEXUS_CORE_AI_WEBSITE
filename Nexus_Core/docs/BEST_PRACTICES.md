...
nexus-core quality output/myskill/
```
...
- Run enhancement: `nexus-core enhance output/myskill/`
...
Nexus Core supports **18 source types**. Here are tips for getting the best results from each category:

### Documentation (Web)
- Always test CSS selectors before large scrapes: `nexus-core create --max-pages 3 --verbose`
...
### Video
- Run `nexus-core create --setup` first to install GPU-optimized dependencies
...
This guide was contributed by the [AI Writing Guide](https://github.com/jmagly/ai-writing-guide) project, which uses Nexus Core for documentation-to-skill conversion. Best practices here are informed by research on production-grade agentic workflows.
