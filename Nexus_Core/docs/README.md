...
> **Complete documentation for Nexus Core v3.7.0**

---

## Welcome!

This is the official documentation for **Nexus Core** - the universal tool for converting **18 source types** (documentation sites, GitHub repos, PDFs, videos, Word docs, EPUB books, Jupyter notebooks, local HTML, OpenAPI specs, AsciiDoc, PowerPoint, RSS/Atom feeds, man pages, Confluence, Notion, Slack/Discord, and local codebases) into AI-ready skills for 21+ platforms.
...
1. [Installation](getting-started/01-installation.md) - Install Nexus Core
...
- [Core Concepts](user-guide/01-core-concepts.md) - How Nexus Core works
...
- **Main Repository:** https://github.com/yusufkaraaslan/Nexus_Core
