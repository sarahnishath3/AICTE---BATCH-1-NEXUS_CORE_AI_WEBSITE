...

{
  "mcpServers": {
    "skill-seeker": {
      "command": "python3",
      "args": [
        "/path/to/Nexus_Core/src/nexus_core/mcp/server_fastmcp.py"
      ],
...
1. Start multiple server instances:
   ...
   python3 -m nexus_core.mcp.server_fastmcp --http --port 3001 &
   ```
...
3. **Explore Agent Detection**: [src/nexus_core/mcp/agent_detector.py](../src/nexus_core/mcp/agent_detector.py)
4. **Try the Quick Start**: [QUICKSTART.md](../docs/archive/legacy/QUICKSTART.md)
...
- [Agent Detector API](../src/nexus_core/mcp/agent_detector.py) - Python API reference
