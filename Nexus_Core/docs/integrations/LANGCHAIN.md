# Using Nexus Core with LangChain
...
Use Nexus Core as **essential preprocessing** before LangChain:
...
**Result:**
Nexus Core outputs JSON files with LangChain Document format, ready to load directly into your RAG pipeline.
