# Using Nexus Core with Pinecone
...
Use Nexus Core to **prepare documentation for Pinecone**:
...
**Result:**
Nexus Core outputs JSON format ready for Pinecone upsert with all metadata intact.
...
def batch_upsert_documents(
    ...
    Args:
        ...
        documents_path: Path to Nexus Core JSON output
    ...
    for i, doc in enumerate(tqdm(documents, desc="Upserting")):
        ...
        vectors.append({
            ...
            "metadata": {
                ...
                **doc["metadata"]  # Preserve all Nexus Core metadata
            }
        })
...
class SupportBotRAG:
    ...
    def ingest_docs(self, docs_path: str):
        """Ingest Nexus Core documentation."""
