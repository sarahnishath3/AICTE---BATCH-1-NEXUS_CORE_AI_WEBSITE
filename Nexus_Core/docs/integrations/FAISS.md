# FAISS Integration with Nexus Core
...
Nexus Core automates FAISS integration with structured, production-ready data:
...
|--------|----------------------|-------------------|
| **Data Preparation** | Custom scraping + embedding generation | One command: `nexus-core create` |
