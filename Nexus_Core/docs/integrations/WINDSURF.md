# Using Nexus Core with Windsurf IDE
...
Use Nexus Core to create **custom rules** for Windsurf's Cascade agent:
...
```bash
# Nexus Core automatically splits large files
...
from nexus_core.mcp.tools import search_docs
...
nexus-core create  godotengine/godot-demo-projects
nexus-core package output/godot-demo-projects --target markdown
...
1. **Try another framework:** `nexus-core create --config configs/vue.json`
