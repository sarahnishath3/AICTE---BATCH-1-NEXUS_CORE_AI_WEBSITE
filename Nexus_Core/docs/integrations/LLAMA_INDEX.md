# Using Nexus Core with LlamaIndex
...
Use Nexus Core as **essential preprocessing** before LlamaIndex:
...
**Result:**
Nexus Core outputs JSON files with LlamaIndex Node format, ready to build indexes and query engines.
...
nexus-core create  django/django --name django-skill
```
...
nexus-core package output/fastapi --target llama-index
```
...
| Aspect | Manual Process | With Nexus Core |
|--------|---------------|-------------------|
