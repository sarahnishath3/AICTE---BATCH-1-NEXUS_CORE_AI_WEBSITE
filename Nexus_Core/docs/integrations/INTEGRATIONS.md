# AI System Integrations with Nexus Core
...
nexus-core package output/fastapi --target pinecone
...
nexus-core package output/django --target markdown  # or --target claude
...
nexus-core package output/vue --target claude

# Upload to Claude
nexus-core upload output/vue-claude.zip --target claude
```
...
nexus-core create --config configs/django.json
nexus-core package output/django --target langchain --chunk-for-rag
...
nexus-core create --config configs/vue.json
nexus-core package output/vue --target markdown
...
nexus-core create --config configs/custom-framework.json

# 2. Analyze internal codebase
nexus-core create /path/to/internal/repo --preset comprehensive
...
nexus-core package output/complete-knowledge --target [platform]
...
nexus-core package output/react --target langchain --chunk-for-rag
...
nexus-core package output/react --target [your-platform]
```

**Quarterly:** Codebase analysis
```bash
# Re-analyze internal codebase for new patterns
nexus-core create . --preset comprehensive
```
...
- **Examples:** [GitHub Examples](https://github.com/yusufkaraaslan/Nexus_Core/tree/main/examples)
...
**Need help deciding?** Ask in [GitHub Discussions](https://github.com/yusufkaraaslan/Nexus_Core/discussions)
