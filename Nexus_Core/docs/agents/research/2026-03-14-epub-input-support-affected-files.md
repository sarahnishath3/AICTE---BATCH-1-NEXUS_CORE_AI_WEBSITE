...
> 🗄️ **Historical — completed** — This research informed the EPUB implementation that is now live in Nexus Core v3.6.0.
...
| File | Purpose |
|------|---------|
| `src/nexus_core/cli/epub_scraper.py` | Core EPUB extraction and skill building logic (analog: `word_scraper.py` at ~750 lines) |
| `src/nexus_core/cli/arguments/epub.py` | EPUB-specific argument definitions (analog: `arguments/word.py`) |
| `src/nexus_core/cli/parsers/epub_parser.py` | Subcommand parser class (analog: `parsers/word_parser.py`) |
...
**`src/nexus_core/cli/source_detector.py`** (3 locations)
...
**`src/nexus_core/cli/main.py`** (2 locations)
...
**`src/nexus_core/cli/create_command.py`** (3 locations)
...
**`src/nexus_core/cli/arguments/create.py`** (4 locations)
...
**`src/nexus_core/cli/parsers/__init__.py`** (2 locations)
...
**`src/nexus_core/cli/arguments/common.py`**
...
- `src/nexus_core/cli/word_scraper.py:1-750` — Full scraper with `WordToSkillConverter` class
- `src/nexus_core/cli/arguments/word.py:1-75` — Argument definitions with `add_word_arguments()`
- `src/nexus_core/cli/parsers/word_parser.py:1-33` — Parser class extending `SubcommandParser`
- `tests/test_word_scraper.py:1-750` — Comprehensive test suite with 130+ tests

### Key Integration Points

- `src/nexus_core/cli/source_detector.py:57-65` — File extension detection order
- `src/nexus_core/cli/source_detector.py:124-129` — `_detect_word()` method (template for `_detect_epub()`)
- `src/nexus_core/cli/create_command.py:121-143` — `_route_to_scraper()` dispatch
- `src/nexus_core/cli/create_command.py:331-352` — `_route_word()` (template for `_route_epub()`)
- `src/nexus_core/cli/arguments/create.py:401-411` — `WORD_ARGUMENTS` dict (template)
- `src/nexus_core/cli/arguments/create.py:595-604` — `get_source_specific_arguments()` mapping
- `src/nexus_core/cli/arguments/create.py:676-678` — `add_create_arguments()` mode handling
- `src/nexus_core/cli/parsers/__init__.py:35-59` — `PARSERS` registry list
- `src/nexus_core/cli/main.py:46-70` — `COMMAND_MODULES` dict
