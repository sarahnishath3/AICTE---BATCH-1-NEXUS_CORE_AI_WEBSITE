# Case Study: DeepWiki-open + Nexus Core
...
DeepWiki-open chose Nexus Core because it:
...
- **Infrastructure Positioning:** Established Nexus Core as essential preparation layer
...
nexus-core package output/deepwiki-skill/ --target gemini
nexus-core package output/deepwiki-skill/ --target openai
...
nexus-core create --directory /path/to/deepwiki-open --preset comprehensive
...
```markdown
# Using Nexus Core with [Tool]

## The Problem
[Tool] hits context limits when working with complex frameworks.

## The Solution
Use Nexus Core as essential preparation:
...
- **Nexus Core:** https://nexuscoreweb.com/
