...
**File:** `src/nexus_core/cli/enhance_skill_local.py:341`  
**Current:**
```python
...
**Files:**
- `src/nexus_core/cli/codebase_scraper.py:422, 489, 575, 720, 746`
- `src/nexus_core/cli/unified_skill_builder.py:1298`
...
**File:** `src/nexus_core/cli/word_scraper.py:595`  
...
**Files:**
- `src/nexus_core/cli/codebase_scraper.py:1898` - `examples[:10]`
- `src/nexus_core/cli/github_scraper.py:1145, 1169` - Pattern limits
- `src/nexus_core/cli/doc_scraper.py:608` - `patterns[:5]`
...
**File:** `src/nexus_core/cli/github_scraper.py`
...
**Files:**
- `src/nexus_core/cli/config_manager.py:540` - `jobs[:5]`
- `src/nexus_core/cli/config_enhancer.py:165, 302` - Config file limits
...
**File:** `src/nexus_core/cli/unified_skill_builder.py:1298`
...
**File:** `src/nexus_core/cli/how_to_guide_builder.py:1018`
...
**File:** `src/nexus_core/sync/notifier.py:138`  
...
**File:** `src/nexus_core/sync/monitor.py:201`
...
def _rebuild_skill(self, config_path: str) -> bool:
    ...
    result = subprocess.run(
        ["nexus-core", "create", config_path, "--force"],
        capture_output=True,
        text=True,
...
**Effort:** 3 hours  
**Dependencies:** Ensure `nexus-core` CLI available in PATH  
**Breaking Change:** No
...
```python
from nexus_core.cli.language_detector import LanguageDetector
...
**File:** `src/nexus_core/cli/enhancement_workflow.py:439`
...
**File:** `src/nexus_core/embedding/server.py:268`
...
**File:** `src/nexus_core/sync/monitor.py:136`
...
### Limit Removals
- `src/nexus_core/cli/enhance_skill_local.py`
- `src/nexus_core/cli/codebase_scraper.py`
- `src/nexus_core/cli/unified_skill_builder.py`
- `src/nexus_core/cli/word_scraper.py`

### Hardcoded Language Fixes
- `src/nexus_core/cli/unified_skill_builder.py` (line 1298)
- `src/nexus_core/cli/how_to_guide_builder.py` (dataclass + lines 955, 1018)

### TODO Implementations
- `src/nexus_core/sync/notifier.py`
- `src/nexus_core/sync/monitor.py`
- `src/nexus_core/cli/how_to_guide_builder.py`
- `src/nexus_core/cli/github_scraper.py` (new flags)
- `src/nexus_core/cli/config_manager.py` (verbose mode)
