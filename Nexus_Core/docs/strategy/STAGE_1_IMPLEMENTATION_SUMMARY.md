...
**File:** `src/nexus_core/cli/codebase_scraper.py`
...
**File:** `src/nexus_core/cli/word_scraper.py`
...
**File:** `src/nexus_core/cli/how_to_guide_builder.py`
...
```
$ python -c "from nexus_core.cli.how_to_guide_builder import HowToGuide; print(hasattr(HowToGuide, 'language'))"
True
```
