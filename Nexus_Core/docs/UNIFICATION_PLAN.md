...
- footer "Skill Seeker" vs "Nexus Core" inconsistency (man)
...
- New `src/nexus_core/services/` package: marketplace_manager,
  ...
  a regression test proves importing services never loads nexus_core.mcp.
