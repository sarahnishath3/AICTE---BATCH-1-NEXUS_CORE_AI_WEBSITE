...
**注意：** 不会删除已缓存的 git 仓库数据。要释放磁盘空间，请手动删除 `~/.nexus-core/cache/{source_name}/`
...
**位置：** `src/nexus_core/mcp/git_repo.py`
...
**位置：** `src/nexus_core/mcp/source_manager.py`
...
**有问题？** 请在 https://github.com/yusufkaraaslan/Nexus_Core/issues 提交 issue
