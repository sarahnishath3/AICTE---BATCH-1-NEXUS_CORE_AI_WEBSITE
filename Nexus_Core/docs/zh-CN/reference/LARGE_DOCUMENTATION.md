...
1. ✅ **先估算**：`nexus-core estimate config.json`
2. ✅ **用路由器拆分**：`python -m nexus_core.cli.split_config config.json --strategy router`
3. ✅ **并行抓取**：多个终端或后台任务
4. ✅ **生成路由器**：`nexus-core create configs/*-*.json`
5. ✅ **全部打包**：`nexus-core package output/*/`
