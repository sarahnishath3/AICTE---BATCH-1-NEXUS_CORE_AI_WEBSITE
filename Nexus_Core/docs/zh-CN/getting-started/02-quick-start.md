...
| 来源类型 | 示例命令 |
|-------------|-----------------|
| **文档网站** | `nexus-core create https://docs.react.dev/` |
| **GitHub 仓库** | `nexus-core create facebook/react` |
| **本地代码** | `nexus-core create ./my-project` |
| **PDF 文件** | `nexus-core create manual.pdf` |
| **Word 文档** | `nexus-core create report.docx` |
| **EPUB 电子书** | `nexus-core create book.epub` |
| **视频** | `nexus-core create https://youtube.com/watch?v=...` |
| **Jupyter Notebook** | `nexus-core create analysis.ipynb` |
| **本地 HTML（文件）** | `nexus-core create page.html` |
| **本地 HTML（目录）** | `nexus-core create ./mirror_output/site/` |
| **OpenAPI 规范** | `nexus-core create api-spec.yaml` |
| **AsciiDoc** | `nexus-core create guide.adoc` |
| **PowerPoint** | `nexus-core create slides.pptx` |
| **RSS/Atom 订阅** | `nexus-core create feed.rss` |
...
| **配置文件** | `nexus-core create configs/custom.json` |

对于一个你还不清楚需要为哪些框架创建技能的现有项目，可使用 `nexus-core scan <dir>` —— 它会通过 AI 检测技术栈，并为每个框架生成一份配置。参见[扫描项目](../../getting-started/05-scan-a-project.md)。
...
```bash
nexus-core create https://docs.react.dev/ --enhance-level 0
nexus-core enhance output/react/  # 稍后增强
```
