...
现在呢？这里是你成为 Nexus Core 高级用户的路线图。
...
```bash
# 核心工作流
nexus-core create <source>              # 创建 skill
nexus-core package <dir> --target <p>   # 打包
nexus-core upload <file> --target <p>   # 上传

# 分析
nexus-core scan  <dir>    # 本地代码库
nexus-core create  <owner/repo>   # GitHub 仓库
nexus-core create --pdf <file>             # PDF

# 工具
nexus-core estimate <config>            # 页面估算
nexus-core quality <dir>                # 质量检查
nexus-core resume                       # 恢复任务
nexus-core workflows list               # 列出工作流

# MCP server
nexus-core-mcp                          # 启动 MCP server
```
