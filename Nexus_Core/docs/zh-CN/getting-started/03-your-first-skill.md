...
✅ **Create** - `nexus-core create <source>` 自动检测并抓取  
...
| 步骤 | 命令 | 时间 |
|------|---------|------|
| 1 | `nexus-core create https://docs.djangoproject.com/` | ~15 分钟 |
| 2 | `nexus-core package output/django/ --target claude` | ~5 秒 |
| 3 | `nexus-core upload output/django-claude.zip` | ~10 秒 |
