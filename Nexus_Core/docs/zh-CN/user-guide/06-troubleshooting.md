...
### 报告问题
1. 收集信息：`nexus-core --version`、`python --version`
2. 启用调试：`nexus-core <command> --verbose 2>&1 | tee debug.log`
3. 创建 issue：https://github.com/yusufkaraaslan/Nexus_Core/issues
