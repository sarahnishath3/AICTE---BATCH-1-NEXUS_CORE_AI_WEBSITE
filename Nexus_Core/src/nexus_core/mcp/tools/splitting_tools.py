...
from nexus_core.mcp.tools._common import TextContent, run_cli_tool
...
async def split_config(args: dict) -> list[TextContent]:
    ...
    from nexus_core.cli import split_config as split_config_cli
...
async def generate_router(args: dict) -> list[TextContent]:
    ...
    from nexus_core.cli import generate_router as generate_router_cli
