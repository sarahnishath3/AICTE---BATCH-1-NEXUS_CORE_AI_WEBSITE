...
class AgentDetector:
    ...
    def generate_config(
        ...
        Args:
            agent_id: Agent identifier
            server_command: Command to start the MCP server (e.g., 'nexus-core mcp')
    ...
    def _generate_stdio_config(self, server_command: str) -> str:
        ...
        command = parts[0] if parts else "nexus-core"
...
def generate_config(
    agent_name: str, server_command: str = "nexus-core mcp", http_port: int = 3000
) -> str | None:
    """
