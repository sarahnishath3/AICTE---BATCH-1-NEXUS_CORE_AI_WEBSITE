...
warnings.warn(
    ...
    "  OLD: python -m nexus_core.mcp.server\n"
    "  NEW: python -m nexus_core.mcp.server_fastmcp\n"
...
try:
    from nexus_core.mcp.tools.config_tools import (
    ...
    from nexus_core.mcp.tools.packaging_tools import (
        install_skill_tool,
        package_skill_tool,
        upload_skill_tool,
    )
    ...
    from nexus_core.mcp.tools.source_tools import (
    ...
    from nexus_core.mcp.tools.splitting_tools import (
...
if __name__ == "__main__":
    try:
        from nexus_core.mcp import server_fastmcp
