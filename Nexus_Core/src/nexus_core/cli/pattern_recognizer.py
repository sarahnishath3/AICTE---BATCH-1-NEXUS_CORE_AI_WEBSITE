...
def main():
    ...
    Usage:
        ...
        nexus-core-patterns --directory src/ --output patterns/
        nexus-core-patterns --file app.py --depth full --json
    """
    import sys
...
""",
    ...
    if args.directory:
        from nexus_core.cli.codebase_scraper import detect_language, walk_directory
    ...
    for file_path in files_to_analyze:
        try:
            from nexus_core.cli.codebase_scraper import detect_language
