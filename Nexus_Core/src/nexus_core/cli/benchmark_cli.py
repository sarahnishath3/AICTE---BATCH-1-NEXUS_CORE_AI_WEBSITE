...
Examples:
  # Run scraping benchmark
  nexus-core-benchmark run --config benchmarks/scraping.json

  # Compare two benchmarks
  nexus-core-benchmark compare \\
    --baseline benchmarks/v1_20250101.json \\
    --current benchmarks/v2_20250115.json

  # List all benchmarks
  nexus-core-benchmark list

  # Show benchmark details
  nexus-core-benchmark show benchmarks/scraping_20250115.json

  # Cleanup old benchmarks
  nexus-core-benchmark cleanup --keep 5
        """,
    )
