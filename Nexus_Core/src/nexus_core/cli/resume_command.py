...
def list_resumable_jobs():
    ...
    print("  $ nexus-core resume <job_id>\n")
...
def resume_job(job_id: str):
    ...
    if not progress:
        ...
        print("Use 'nexus-core resume --list' to see available jobs.\n")
        return 1
...
def main(args=None):
    ...
    from nexus_core.cli.parsers.resume_parser import ResumeParser
