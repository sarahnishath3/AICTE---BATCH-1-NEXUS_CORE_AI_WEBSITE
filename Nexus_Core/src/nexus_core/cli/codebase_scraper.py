...
from nexus_core.cli.api_reference_builder import APIReferenceBuilder
from nexus_core.cli.code_analyzer import CodeAnalyzer
from nexus_core.cli.config_extractor import ConfigExtractor
from nexus_core.cli.dependency_analyzer import DependencyAnalyzer
from nexus_core.cli.signal_flow_analyzer import SignalFlowAnalyzer
...
def extract_rst_structure(content: str) -> dict[str, Any]:
    ...
    try:
        from nexus_core.cli.parsers.extractors import RstParser
...
def process_markdown_docs(
    ...
    try:
        from nexus_core.cli.parsers.extractors import RstParser, MarkdownParser
    except ImportError:
...
def analyze_codebase(
    ...
    if detect_patterns:
        ...
        if enhance_patterns and pattern_results:
            ...
            from nexus_core.cli.ai_enhancer import PatternEnhancer
        ...
        if pattern_results:
            ...
            from nexus_core.cli.pattern_recognizer import create_multi_level_report
        ...
        try:
            ...
            if extraction_result.config_files:
                ...
                if enhance_config and ai_mode != "none":
                    try:
                        from nexus_core.cli.config_enhancer import ConfigEnhancer
    ...
    from nexus_core.cli.architectural_pattern_detector import ArchitecturalPatternDetector
