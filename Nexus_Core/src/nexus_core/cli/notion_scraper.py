...
Usage:
    nexus-core notion --database-id ID --token $NOTION_TOKEN --name myskill
    nexus-core notion --page-id ID --token $NOTION_TOKEN --name myskill
    nexus-core notion --export-path ./notion-export/ --name myskill
    nexus-core notion --from-json output/myskill_notion_data.json --name myskill
"""
...
def _check_notion_deps() -> None:
    ...
    if not NOTION_AVAILABLE:
        raise RuntimeError(
            ...
            'Install with: pip install "nexus-core[notion]"\n'
