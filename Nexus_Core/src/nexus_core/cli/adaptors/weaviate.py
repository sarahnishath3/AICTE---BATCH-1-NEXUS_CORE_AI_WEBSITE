...
Converts Nexus Core documentation into Weaviate-compatible objects with schema.
"""
...
class WeaviateAdaptor(StreamingAdaptorMixin, SkillAdaptor):
    ...
    def _generate_schema(self, class_name: str) -> dict:
        ...
        return {
            "class": class_name,
            "description": "Documentation chunks from Nexus Core",
    ...
    def supports_enhancement(self) -> bool:
        ...
        nexus-core enhance output/skill/ --mode LOCAL
    ...
    def enhance(self, _skill_dir: Path, _api_key: str) -> bool:
        ...
        print("   nexus-core enhance output/skill/ --mode LOCAL")
        print("   nexus-core package output/skill/ --target weaviate")
        return False
