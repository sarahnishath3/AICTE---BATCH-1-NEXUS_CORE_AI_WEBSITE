...
Usage:
    nexus-core asciidoc --asciidoc-path doc.adoc --name myskill
    nexus-core asciidoc --asciidoc-path docs/ --name myskill
    nexus-core asciidoc --from-json doc_extracted.json
"""
...
from nexus_core.cli.scraper_utils import reference_filename
...
def _check_asciidoc_deps() -> None:
    ...
    if not ASCIIDOC_AVAILABLE:
        logger.debug(
            ...
            'Install with: pip install "nexus-core[asciidoc]" or: pip install asciidoc'
        )
