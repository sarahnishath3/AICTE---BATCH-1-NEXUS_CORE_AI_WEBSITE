...
Usage:
    nexus-core pptx --pptx presentation.pptx --name myskill
    nexus-core pptx --pptx ./slides_dir/ --name myskill
    nexus-core pptx --from-json presentation_extracted.json
"""
...
def _check_pptx_deps() -> None:
    ...
    if not PPTX_AVAILABLE:
        raise RuntimeError(
            ...
            'Install with: pip install "nexus-core[pptx]"\n'
