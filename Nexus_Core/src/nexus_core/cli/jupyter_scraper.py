...
Usage:
    nexus-core jupyter --notebook notebook.ipynb --name myskill
    nexus-core jupyter --notebook ./notebooks/ --name myskill
    nexus-core jupyter --from-json notebook_extracted.json
"""
...
from nexus_core.cli.scraper_utils import score_code_quality
...
def _check_jupyter_deps():
    ...
    if not JUPYTER_AVAILABLE:
        raise RuntimeError(
            ...
            'Install with: pip install "nexus-core[jupyter]"\n'
