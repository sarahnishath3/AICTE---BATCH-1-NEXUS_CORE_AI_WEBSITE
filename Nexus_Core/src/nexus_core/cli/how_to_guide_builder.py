...
Usage:
    ...
    nexus-core build-how-to-guides --input test_examples.json

    # From directory (auto-extracts workflows)
    nexus-core build-how-to-guides tests/

    # With AI enhancement
    nexus-core build-how-to-guides tests/ --enhance-with-ai
...
Examples:
  ...
  nexus-core build-how-to-guides tests/ --group-by file-path

  # Custom output directory
  nexus-core build-how-to-guides tests/ --output tutorials/

  # Without AI enhancement
  nexus-core build-how-to-guides tests/ --no-ai
...
""",
    ...
    if input_path.is_file() and input_path.suffix == ".json":
        ...
        print(f"   Or run: nexus-core extract-test-examples {input_path} --json > examples.json")
        sys.exit(1)
