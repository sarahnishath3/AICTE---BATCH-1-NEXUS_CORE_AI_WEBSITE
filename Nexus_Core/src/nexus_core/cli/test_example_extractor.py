...
class TestExampleExtractor:
    ...
    def __init__(
        ...
        if self.enhance_with_ai:
            try:
                from nexus_core.cli.ai_enhancer import TestExampleEnhancer
...
def main(args=None):
    ...
    from nexus_core.cli.exit_codes import EXIT_SUCCESS
    from nexus_core.cli.parsers.test_examples_parser import TestExamplesParser
