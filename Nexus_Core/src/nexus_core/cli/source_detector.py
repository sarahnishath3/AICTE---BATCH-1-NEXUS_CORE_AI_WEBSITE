...
subcommands (``nexus-core confluence``, ``notion``, ``chat``) instead.
"""
...
class SourceDetector:
    ...
    def detect(cls, source: str) -> SourceInfo:
        ...
        raise ValueError(
            ...
            "  Jupyter:    nexus-core create notebook.ipynb\n"
            "  HTML:       nexus-core create page.html\n"
            "  OpenAPI:    nexus-core create openapi.yaml\n"
            "  AsciiDoc:   nexus-core create document.adoc\n"
            "  PowerPoint: nexus-core create presentation.pptx\n"
            "  RSS:        nexus-core create feed.rss\n"
            "  Man page:   nexus-core create command.1\n"
