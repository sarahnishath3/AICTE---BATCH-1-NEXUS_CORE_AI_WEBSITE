...
from nexus_core.cli.arguments.create import (
...
class CreateCommand:
    ...
    def _resolve_detection_input(self) -> str:
        ...
        ``nexus-core create --html-path PATH`` works without a positional.
        ...
        raise ValueError(
            ...
            "argument (e.g., 'nexus-core create ./docs')."
        )
...
Examples:
  ...
  GitHub:   nexus-core create facebook/react -p standard
  Local:    nexus-core create ./my-project -p comprehensive
  PDF:      nexus-core create tutorial.pdf --ocr
  DOCX:     nexus-core create document.docx
  EPUB:     nexus-core create ebook.epub
  Video:    nexus-core create https://youtube.com/watch?v=...
  Video:    nexus-core create recording.mp4
...
Common Workflows:
  nexus-core create <source> -p quick
  nexus-core create <source> -p standard --enhance-level 2
  nexus-core create <source> --chunk-for-rag
        """),
    )
