...
CONVERTER_REGISTRY: dict[str, tuple[str, str]] = {
    "web": ("nexus_core.cli.doc_scraper", "DocToSkillConverter"),
    "github": ("nexus_core.cli.github_scraper", "GitHubScraper"),
    "pdf": ("nexus_core.cli.pdf_scraper", "PDFToSkillConverter"),
    "word": ("nexus_core.cli.word_scraper", "WordToSkillConverter"),
    "epub": ("nexus_core.cli.epub_scraper", "EpubToSkillConverter"),
    "video": ("nexus_core.cli.video_scraper", "VideoToSkillConverter"),
    "local": ("nexus_core.cli.codebase_scraper", "CodebaseAnalyzer"),
    "jupyter": ("nexus_core.cli.jupyter_scraper", "JupyterToSkillConverter"),
    "html": ("nexus_core.cli.html_scraper", "HtmlToSkillConverter"),
    "openapi": ("nexus_core.cli.openapi_scraper", "OpenAPIToSkillConverter"),
    "asciidoc": ("nexus_core.cli.asciidoc_scraper", "AsciiDocToSkillConverter"),
    "pptx": ("nexus_core.cli.pptx_scraper", "PptxToSkillConverter"),
    "rss": ("nexus_core.cli.rss_scraper", "RssToSkillConverter"),
    "manpage": ("nexus_core.cli.man_scraper", "ManPageToSkillConverter"),
    "confluence": ("nexus_core.cli.confluence_scraper", "ConfluenceToSkillConverter"),
    "notion": ("nexus_core.cli.notion_scraper", "NotionToSkillConverter"),
    "chat": ("nexus_core.cli.chat_scraper", "ChatToSkillConverter"),
    ...
    "config": ("nexus_core.cli.unified_scraper", "UnifiedScraper"),
}
