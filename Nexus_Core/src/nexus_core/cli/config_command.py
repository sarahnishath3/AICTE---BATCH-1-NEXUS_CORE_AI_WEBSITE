"""
Interactive Configuration Wizard for Nexus Core
...
Documentation: https://github.com/SkillSeekers/nexus-core
...
def main_menu():
    ...
    while True:
        print("\n╔═══════════════════════════════════════════════════╗")
        print("║         Nexus Core Configuration              ║")
        print("╚═══════════════════════════════════════════════════╝\n")
...
def main(args=None):
    ...
    if args is None:
        ...
        from nexus_core.cli.parsers.config_parser import ConfigParser
