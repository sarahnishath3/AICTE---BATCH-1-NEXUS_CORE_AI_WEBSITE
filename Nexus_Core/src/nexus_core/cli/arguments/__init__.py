...
Usage:
    from nexus_core.cli.arguments.scrape import add_scrape_arguments
    from nexus_core.cli.arguments.github import add_github_arguments
    from nexus_core.cli.arguments.pdf import add_pdf_arguments
    from nexus_core.cli.arguments.analyze import add_analyze_arguments
    from nexus_core.cli.arguments.unified import add_unified_arguments
    from nexus_core.cli.arguments.package import add_package_arguments
    from nexus_core.cli.arguments.upload import add_upload_arguments
