...
from nexus_core.cli.constants import DEFAULT_RATE_LIMIT
...
SCRAPE_ARGUMENTS: dict[str, dict[str, Any]] = {
    ...
    "browser": {
        ...
        "kwargs": {
            "action": "store_true",
            "help": "Use headless browser (Playwright) to render JavaScript SPA sites. Install: pip install 'nexus-core[browser]'",
        },
    },
