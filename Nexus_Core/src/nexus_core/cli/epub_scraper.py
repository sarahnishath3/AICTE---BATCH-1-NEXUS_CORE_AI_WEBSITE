...
Usage:
    nexus-core epub --epub book.epub --name myskill
    nexus-core epub --from-json book_extracted.json
"""
...
from nexus_core.cli.scraper_utils import extract_table_from_html as _extract_table_from_html
from nexus_core.cli.scraper_utils import parse_leading_int as _parse_leading_int
    ...
    def extract_epub(self):
        ...
        if self._detect_drm(book):
            raise RuntimeError(
                ...
                "Nexus Core cannot process DRM-protected files.\n"
