...
Usage:
    ...
    nexus-core estimate configs/godot.json --max-discovery 2000
"""
...
def load_config(config_path):
    ...
    if isinstance(config_path, str) and config_path.startswith(("http://", "https://")):
        ...
        print(f"     nexus-core create {config_path} --dry-run   # writes a config")
        print("     nexus-core estimate <config.json>")
        sys.exit(EXIT_ERROR)
    try:
...
def find_configs_directory():
    ...
    """
    # Get the package root (src/nexus_core/)
