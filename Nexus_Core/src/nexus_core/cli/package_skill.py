...
Usage:
    nexus-core package output/steam-inventory/
    nexus-core package output/react/
    nexus-core package output/react/ --no-open  # Don't open folder
"""
...
from nexus_core.cli.arguments.common import DEFAULT_CHUNK_TOKENS, DEFAULT_CHUNK_OVERLAP_TOKENS
...
Examples:
  ...
  nexus-core package output/react/ --no-open
  ...
  nexus-core package --help
    ...
    if marketplace_name:
        try:
            from nexus_core.mcp.marketplace_publisher import MarketplacePublisher
