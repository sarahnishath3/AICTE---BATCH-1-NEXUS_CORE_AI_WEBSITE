...
_INSTALL_MSG = (
    ...
    "Recommended: nexus-core video --setup  (auto-detects GPU, installs correct PyTorch)\n"
    'Alternative:  pip install "nexus-core[video-full]"  (may install wrong PyTorch variant)'
)
...
def _run_tesseract_ocr(preprocessed_path: str, frame_type: FrameType) -> list[tuple]:  # noqa: ARG001
    ...
    try:
        ...
        logger.warning(
            ...
            "Install tesseract binary: nexus-core video --setup"
        )
        return []
    finally:
