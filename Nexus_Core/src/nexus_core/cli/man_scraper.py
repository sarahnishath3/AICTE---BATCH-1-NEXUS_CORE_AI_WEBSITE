...
Usage:
    nexus-core man --man-names git,curl --name unix-tools
    nexus-core man --man-path /usr/share/man/man1 --name coreutils
    nexus-core man --from-json unix-tools_extracted.json
"""
