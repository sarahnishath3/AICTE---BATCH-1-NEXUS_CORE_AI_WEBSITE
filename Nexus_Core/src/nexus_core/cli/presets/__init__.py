"""Preset system for Nexus Core CLI commands.
...
Usage:
    nexus-core scrape https://docs.example.com --preset quick
    nexus-core github --repo owner/repo --preset standard
    nexus-core analyze --directory . --preset comprehensive
