...
Examples:
    nexus-core analyze --directory . --preset quick
    nexus-core analyze --directory . --preset quick --enhance
    nexus-core analyze --directory . --preset comprehensive --enhance-level 2
"""
...
def show_preset_list() -> None:
    ...
    print()
    print("Examples:")
    print("  nexus-core analyze --directory <dir> --preset quick")
    print("  nexus-core analyze --directory <dir> --preset quick --enhance")
    print("  nexus-core analyze --directory <dir> --preset comprehensive --enhance-level 2")
    print()
