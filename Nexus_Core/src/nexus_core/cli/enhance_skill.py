...
Usage:
    ...
    nexus-core enhance output/react/ --api-key sk-ant-...
...
from nexus_core.cli.constants import API_CONTENT_LIMIT, API_PREVIEW_LIMIT
...
"""
    ...
    def save_enhanced_skill_md(self, content):
        ...
        """
        from nexus_core.cli.adaptors.base import save_skill_md_atomic
    ...
    def run(self):
        ...
        print(f"     nexus-core package {self.skill_dir}/")
...
Examples:
  ...
  # Dry run
  nexus-core enhance output/godot/ --dry-run
""",
    )
    ...
    from nexus_core.cli.adaptors import get_enhancement_platforms
    ...
    if args.dry_run:
        ...
        print(f"  nexus-core enhance {skill_dir}")
        return
    ...
    try:
        ...
        if not api_key:
            ...
            print(f"  nexus-core enhance {skill_dir} --target {args.target} --api-key ...")
            sys.exit(1)
        ...
        if success:
            ...
            print("  3. Package your skill:")
            print(f"     nexus-core package {skill_dir}/ --target {args.target}")

        sys.exit(0 if success else 1)

    except ImportError as e:
        print(f"❌ Error: {e}")
        print("\nAdaptor system not available. Reinstall nexus-core.")
        sys.exit(1)
