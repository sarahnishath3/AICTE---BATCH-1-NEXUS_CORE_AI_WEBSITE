...
class SourceManager:
    """Manages config source registry at ~/.nexus-core/sources.json"""
    ...
    def __init__(self, config_dir: str | None = None):
        ...
        Args:
            config_dir: Base config directory. Defaults to ~/.nexus-core/
        """
        if config_dir:
            self.config_dir = Path(config_dir)
        else:
            self.config_dir = Path.home() / ".nexus-core"
...
REGISTRY_REPO = "yusufkaraaslan/nexus-core-configs"
