...
Complete example showing how to upsert Nexus Core documents to Pinecone and perform semantic search.

## What This Example Does

1. **Creates** a Pinecone serverless index
2. **Loads** Nexus Core-generated documents (LangChain format)
...
First, generate LangChain-format documents using Nexus Core:
...
nexus-core create --repo django/django --name django
nexus-core package output/django --target langchain
...
index = pc.Index("nexus-core-demo")
...
**Need help?** [GitHub Discussions](https://github.com/yusufkaraaslan/Nexus_Core/discussions)
