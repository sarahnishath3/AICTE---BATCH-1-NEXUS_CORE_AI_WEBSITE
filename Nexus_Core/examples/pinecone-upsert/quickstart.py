...
1. Load Nexus Core documents (LangChain format)
...
def load_documents(json_path: str) -> List[Dict]:
    """
    Load documents from Nexus Core JSON output.

    Args:
        json_path: Path to nexus-core generated JSON file
...
def main():
    ...
    if not Path(DOCS_PATH).exists():
        ...
        print("  1. nexus-core create --config configs/django.json")
        print("  2. nexus-core package output/django --target langchain")
