...
Complete example showing how to use Nexus Core to generate Cursor rules for React development.
...
- `requirements.txt` - Python dependencies (nexus-core)
...
### Issue: nexus-core not found

**Solution:** Install Nexus Core
