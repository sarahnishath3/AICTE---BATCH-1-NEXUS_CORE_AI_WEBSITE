#!/usr/bin/env python3
"""
Quickstart script for Continue.dev + Nexus Core integration.
...
def main():
    parser = argparse.ArgumentParser(
        description="Quickstart script for Continue.dev + Nexus Core"
    )
    parser.add_argument(
        "--framework",
        type=str,
    ...
    print("=" * 60)
    print("Continue.dev + Nexus Core Quickstart")
    print("=" * 60)
