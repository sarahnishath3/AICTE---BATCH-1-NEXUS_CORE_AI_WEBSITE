...
This example demonstrates how to use Nexus Core with Weaviate, a powerful vector database with hybrid search capabilities (keyword + semantic).
...
```bash
nexus-core create --config configs/your_framework.json
nexus-core package output/your_framework --target weaviate
```
...
- **Nexus Core Docs**: https://github.com/yourusername/nexus-core
...
**Tested With:** Weaviate v1.25.0, Python 3.10+, nexus-core v3.6.0
