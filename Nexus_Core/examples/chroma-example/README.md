...
This example demonstrates how to use Nexus Core with ChromaDB, the AI-native open-source embedding database. Chroma is designed to be simple, fast, and easy to use locally.
...
# Or use CLI directly
nexus-core create --config configs/flask.json
nexus-core package output/flask --target chroma
```
...
- **Nexus Core**: https://github.com/yourusername/nexus-core
...
**Tested With:** ChromaDB v0.4.22, Python 3.10+, nexus-core v3.6.0
