...
Complete example showing how to use Nexus Core with Haystack 2.x for building RAG pipelines.
...
nexus-core create --config configs/react.json --max-pages 100

# Package for Haystack
nexus-core package output/react --target haystack
```
...
nexus-core create --config configs/react.json --max-pages 100 --chunk-for-rag --chunk-tokens 512 --chunk-overlap-tokens 50
...
```bash
# Semantic chunking
nexus-core create --config configs/react.json --chunk-for-rag
...
- [Nexus Core Documentation](https://github.com/yusufkaraaslan/Nexus_Core)
