...
Demonstrates how to use Nexus Core documentation with Haystack 2.x
...
def main():
    ...
    if not docs_path.exists():
        ...
        print("   nexus-core create --config configs/react.json --max-pages 100")
        print("   nexus-core package output/react --target haystack")
        sys.exit(1)
