...
def load_documents(json_path: str) -> list[Document]:
    """
    Load LangChain Documents from Nexus Core JSON output.
...
def main():
    ...
    if not Path(DOCS_PATH).exists():
        ...
        print("  1. nexus-core create --config configs/react.json")
        print("  2. nexus-core package output/react --target langchain")
        return
