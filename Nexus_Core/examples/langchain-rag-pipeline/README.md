...
Complete example showing how to build a RAG (Retrieval-Augmented Generation) pipeline using Nexus Core documents with LangChain.

## What This Example Does

1. **Loads** Nexus Core-generated LangChain Documents
...
First, generate LangChain documents using Nexus Core:
...
nexus-core create --repo facebook/react --name react
nexus-core package output/react --target langchain
