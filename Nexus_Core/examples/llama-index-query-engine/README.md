...
Complete example showing how to build a query engine using Nexus Core nodes with LlamaIndex.

## What This Example Does

1. **Loads** Nexus Core-generated LlamaIndex Nodes
...
First, generate LlamaIndex nodes using Nexus Core:
