...
class TestC3Integration:
    ...
    def test_graceful_degradation_on_c3_failure(self, mock_config, temp_dir):
        ...
        with patch("nexus_core.cli.unified_scraper.UnifiedScraper._run_c3_analysis") as mock_c3:
            ...
            with patch("nexus_core.cli.github_scraper.GitHubScraper") as mock_github:
...
class TestC3AnalyzeCodebaseSignature:
    ...
    def test_run_c3_analysis_uses_enhance_level_not_old_kwargs(self, temp_dir):
        ...
        with patch("nexus_core.cli.codebase_scraper.analyze_codebase", fake_analyze):
