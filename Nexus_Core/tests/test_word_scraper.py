...
class TestWordToSkillConverterInit(unittest.TestCase):
    ...
    def setUp(self):
        ...
        from nexus_core.cli.word_scraper import WordToSkillConverter
    ...
    def test_name_auto_detected_from_filename(self):
        ...
        from nexus_core.cli.word_scraper import infer_description_from_word
...
class TestWordHelperFunctions(unittest.TestCase):
    ...
    def test_build_section_basic(self):
        ...
        from nexus_core.cli.word_scraper import _build_section
    ...
    def test_extract_table_from_html(self):
        ...
        from nexus_core.cli.word_scraper import _extract_table_from_html
        from bs4 import BeautifulSoup
    ...
    def test_score_code_quality_basic(self):
        ...
        from nexus_core.cli.word_scraper import _score_code_quality
...
class TestWordExtractionReal(unittest.TestCase):
    ...
    def setUp(self):
        from nexus_core.cli.word_scraper import WordToSkillConverter, WORD_AVAILABLE
