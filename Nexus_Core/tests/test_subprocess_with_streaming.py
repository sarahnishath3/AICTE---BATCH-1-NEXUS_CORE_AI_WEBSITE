...
from nexus_core.mcp.tools.packaging_tools import run_subprocess_with_streaming
...
class TestSharedHelperIsDeduplicated(unittest.TestCase):
    ...
    def test_tool_modules_use_shared_helper(self):
        ...
        from nexus_core.mcp.tools import (
            subprocess_utils,
            packaging_tools,
        )
    ...
    def test_server_legacy_uses_shared_helper(self):
        from nexus_core.mcp.tools import subprocess_utils
        from nexus_core.mcp import server_legacy
    ...
    def test_migrated_modules_do_not_shell_out(self):
        ...
        from nexus_core.mcp.tools import _common, scraping_tools, splitting_tools
