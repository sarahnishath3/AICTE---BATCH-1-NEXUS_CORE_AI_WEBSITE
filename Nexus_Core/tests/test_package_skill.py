...
from nexus_core.cli.package_skill import package_skill
...
class TestPackageSkillCLI(unittest.TestCase):
    ...
    def test_cli_help_output(self):
        """Test that nexus-core package --help works"""
        import subprocess

        try:
            result = subprocess.run(
                ["nexus-core", "package", "--help"], capture_output=True, text=True, timeout=5
            )
    ...
    def test_cli_executes_without_errors(self):
        """Test that nexus-core-package entry point works"""
        import subprocess
        ...
        try:
            ...
            self.skipTest("nexus-core-package command not installed")
