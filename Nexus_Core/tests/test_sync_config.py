...
from nexus_core.cli.sync_config import (
    _get_doc_source,
    _is_valid_url,
    _set_start_urls,
    diff_urls,
...
class TestDiscoverUrls(unittest.TestCase):
    ...
    @patch("nexus_core.cli.sync_config.requests.get")
...
class TestSyncConfigIntegration(unittest.TestCase):
    ...
    @patch("nexus_core.cli.sync_config.discover_urls")
...
class TestSyncConfigCLI(unittest.TestCase):
    ...
    def test_arguments_created(self):
        ...
        from nexus_core.cli.arguments.sync_config import add_sync_config_arguments
...
class TestSyncConfigMCPTool(unittest.TestCase):
    ...
    def test_mcp_tool_importable(self):
        ...
        from nexus_core.mcp.tools import sync_config_impl
    ...
    def test_mcp_tool_missing_config_path(self):
        ...
        from nexus_core.mcp.tools.sync_config_tools import sync_config_tool
