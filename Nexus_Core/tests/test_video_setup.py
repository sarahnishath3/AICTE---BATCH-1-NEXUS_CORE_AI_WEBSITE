...
from nexus_core.cli.video_setup import (
    _BASE_VIDEO_DEPS,
    GPUInfo,
    GPUVendor,
    SetupModules,
...
class TestGPUDetection(unittest.TestCase):
    ...
    @patch("nexus_core.cli.video_setup.shutil.which")
    @patch("nexus_core.cli.video_setup.subprocess.run")
    ...
    @patch("nexus_core.cli.video_setup.shutil.which")
    @patch("nexus_core.cli.video_setup.subprocess.run")
    @patch("nexus_core.cli.video_setup._read_rocm_version", return_value="6.3.1")
    ...
    @patch("nexus_core.cli.video_setup.shutil.which", return_value=None)
...
class TestVenv(unittest.TestCase):
    ...
    def test_get_venv_python_linux(self):
        with patch("nexus_core.cli.video_setup.platform.system", return_value="Linux"):
...
class TestSystemDeps(unittest.TestCase):
    ...
    @patch("nexus_core.cli.video_setup.subprocess.run")
    @patch("nexus_core.cli.video_setup.shutil.which", return_value="/usr/bin/tesseract")
...
class TestRunSetup(unittest.TestCase):
    ...
    @patch("nexus_core.cli.video_setup.verify_installation")
    @patch("nexus_core.cli.video_setup.install_visual_deps", return_value=True)
    @patch("nexus_core.cli.video_setup.install_torch", return_value=True)
    @patch("nexus_core.cli.video_setup.check_tesseract")
    @patch("nexus_core.cli.video_setup.detect_gpu")
    ...
    @patch("nexus_core.cli.video_setup.install_torch", return_value=False)
    @patch("nexus_core.cli.video_setup.check_tesseract")
    @patch("nexus_core.cli.video_setup.detect_gpu")
    ...
    @patch("nexus_core.cli.video_setup.install_torch", return_value=True)
    @patch("nexus_core.cli.video_setup.install_visual_deps", return_value=False)
    @patch("nexus_core.cli.video_setup.check_tesseract")
    @patch("nexus_core.cli.video_setup.detect_gpu")
...
class TestTesseractCircuitBreaker(unittest.TestCase):
    ...
    def test_circuit_breaker_flag_exists(self):
        import nexus_core.cli.video_visual as vv
...
class TestVideoScraperSetupEarlyExit(unittest.TestCase):
    ...
    @patch("nexus_core.cli.video_setup.run_setup", return_value=0)
    def test_setup_runs_successfully(self, mock_setup):
        """run_setup(interactive=True) should return 0 on success."""
        from nexus_core.cli.video_setup import run_setup
