...
from nexus_core.sync.notifier import Notifier
from nexus_core.sync.models import WebhookPayload, ChangeReport, PageChange, ChangeType
...
class TestNotifier:
    ...
    @patch("nexus_core.sync.notifier.requests.post")
