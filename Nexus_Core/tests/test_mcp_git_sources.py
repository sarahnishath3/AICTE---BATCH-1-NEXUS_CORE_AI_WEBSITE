...
class TestFetchConfigModes:
    ...
    async def test_fetch_config_api_mode_list(self):
        ...
        from nexus_core.mcp.server import fetch_config_tool

        with patch("nexus_core.mcp.tools.source_tools.httpx.AsyncClient") as mock_client:
            # Mock API response
    ...
    async def test_fetch_config_api_mode_download(self, temp_dirs):
        ...
        with patch("nexus_core.mcp.tools.source_tools.httpx.AsyncClient") as mock_client:
            ...
            mock_detail_response.json.return_value = {
                ...
                "category": "web-frameworks",
                "description": "React framework",
                "download_url": "https://api.nexuscoreweb.com/api/configs/react/download",
            }
    ...
    @patch("nexus_core.services.git_repo.GitConfigRepo")
    ...
    @patch("nexus_core.services.git_repo.GitConfigRepo")
    @patch("nexus_core.services.source_manager.SourceManager")
    ...
    async def test_fetch_config_source_not_found(self):
        ...
        with patch("nexus_core.services.source_manager.SourceManager") as mock_sm_class:
            mock_sm = MagicMock()
...
class TestSourceManagementTools:
    ...
    async def test_add_config_source(self, temp_dirs):
        ...
        from nexus_core.mcp.server import add_config_source_tool
    ...
    async def test_list_config_sources(self):
        ...
        from nexus_core.mcp.server import list_config_sources_tool
    ...
    async def test_remove_config_source(self):
        ...
        from nexus_core.mcp.server import remove_config_source_tool
...
class TestCompleteWorkflow:
    ...
    async def test_add_fetch_remove_workflow(self, mock_sm_class, mock_git_repo_class, temp_dirs):
        ...
        from nexus_core.mcp.server import (
