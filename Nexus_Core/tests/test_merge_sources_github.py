...
import nexus_core.cli.merge_sources as merge_sources_module
from nexus_core.cli.conflict_detector import Conflict
from nexus_core.cli.github_fetcher import CodeStream, DocsStream, InsightsStream, ThreeStreamData
from nexus_core.cli.merge_sources import (
    AIEnhancedMerger,
...
class TestMainModuleExecution:
    """Regression tests for `python -m nexus_core.cli.merge_sources`.
