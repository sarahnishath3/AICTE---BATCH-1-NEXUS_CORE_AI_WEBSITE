...
# `nexus-core create`.  The routing is tested in TestCreateCommandRouting.
...
class TestCreateCommandRouting:
    ...
    def test_optional_dep_checks_are_wired_correctly(self):
        ...
        from nexus_core.cli.skill_converter import (
            CONVERTER_REGISTRY,
            OPTIONAL_DEP_CHECKS,
        )
    ...
    def test_get_converter_fails_fast_when_optional_dep_missing(self):
        ...
        with (
            patch("nexus_core.cli.jupyter_scraper.JUPYTER_AVAILABLE", False),
...
class TestCreateCommandHtmlPath:
    ...
    def _make_args(**overrides):
        ...
        import argparse
        from nexus_core.cli.arguments.create import get_create_defaults
    ...
    def test_html_path_overrides_local_detection_for_mixed_dir(self, tmp_path):
        ...
        from nexus_core.cli.create_command import CreateCommand
    ...
    def test_build_config_uses_explicit_html_path(self, tmp_path):
        ...
        from nexus_core.cli.source_detector import SourceInfo
