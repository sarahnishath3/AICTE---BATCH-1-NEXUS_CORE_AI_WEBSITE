...
from nexus_core.embedding.models import (
    EmbeddingRequest,
...
from nexus_core.embedding.cache import EmbeddingCache
...
@patch("nexus_core.embedding.generator.SENTENCE_TRANSFORMERS_AVAILABLE", False)
...
@patch("nexus_core.embedding.generator.OPENAI_AVAILABLE", False)
...
@patch("nexus_core.embedding.generator.VOYAGE_AVAILABLE", False)
