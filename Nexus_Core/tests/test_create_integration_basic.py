...
class TestCreateCommandBasic:
    ...
    def test_create_command_help(self):
        ...
        result = subprocess.run(
            ["nexus-core", "create", "--help"], capture_output=True, text=True
        )
    ...
    def test_create_detects_github_repo(self):
        ...
        result = subprocess.run(
            ["nexus-core", "create", "facebook/react", "--help"],
            capture_output=True,
            text=True,
            timeout=10,
        )
    ...
    def test_create_detects_local_directory(self, tmp_path):
        ...
        result = subprocess.run(
            ["nexus-core", "create", str(test_dir), "--help"],
            capture_output=True,
            text=True,
            timeout=10,
        )
    ...
    def test_create_detects_pdf_file(self, tmp_path):
        ...
        result = subprocess.run(
            ["nexus-core", "create", str(pdf_file), "--help"],
            capture_output=True,
            text=True,
            timeout=10,
        )
    ...
    def test_create_detects_config_file(self, tmp_path):
        ...
        result = subprocess.run(
            ["nexus-core", "create", str(config_file), "--help"],
            capture_output=True,
            text=True,
            timeout=10,
        )
...
class TestUnifiedCommands:
    ...
    def test_main_help_shows_available_commands(self):
        ...
        result = subprocess.run(
            ["nexus-core", "--help"], capture_output=True, text=True, timeout=10
        )
        assert result.returncode == 0
...
class TestRemovedCommands:
    ...
    def test_scrape_command_removed(self):
        ...
        result = subprocess.run(
            ["nexus-core", "scrape", "--help"], capture_output=True, text=True, timeout=10
        )
    ...
    def test_github_command_removed(self):
        ...
        result = subprocess.run(
            ["nexus-core", "github", "--help"], capture_output=True, text=True, timeout=10
        )
        # Should fail - command removed
        assert result.returncode == 2
        assert "invalid choice" in result.stderr
