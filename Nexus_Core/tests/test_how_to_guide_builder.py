...
from nexus_core.cli.guide_enhancer import StepEnhancement
from nexus_core.cli.how_to_guide_builder import (
    GuideCollection,
    GuideGenerator,
    HowToGuide,
    HowToGuideBuilder,
...
def test_data_scraping():
    ...
    assert result.pages > 0
        ...
        with patch("nexus_core.cli.guide_enhancer.GuideEnhancer") as MockEnhancer:
...
def test_file_processing():
    ...
    assert result.rows == 100
        ...
        with patch(
            "nexus_core.cli.guide_enhancer.GuideEnhancer",
