...
def user_dir(tmp_path, monkeypatch):
    ...
    monkeypatch.setattr(
        "nexus_core.mcp.tools.workflow_tools.USER_WORKFLOWS_DIR",
        fake_dir,
    )
    return fake_dir
...
def bundled_names_empty(monkeypatch):
    ...
    monkeypatch.setattr(
        "nexus_core.mcp.tools.workflow_tools._bundled_names",
        lambda: [],
    )
...
def bundled_fixture(monkeypatch):
    ...
    monkeypatch.setattr(
        "nexus_core.mcp.tools.workflow_tools._read_bundled",
...
class TestListWorkflowsTool:
    def test_empty_returns_empty_list(self, user_dir, bundled_names_empty, monkeypatch):
        ...
        from nexus_core.mcp.tools.workflow_tools import list_workflows_tool
...
class TestGetWorkflowTool:
    def test_missing_name_returns_error(self, user_dir, bundled_names_empty, monkeypatch):
        ...
        from nexus_core.mcp.tools.workflow_tools import get_workflow_tool
...
class TestCreateWorkflowTool:
    def test_missing_name_returns_error(self, user_dir):
        from nexus_core.mcp.tools.workflow_tools import create_workflow_tool
...
class TestUpdateWorkflowTool:
    def test_missing_name_returns_error(self, user_dir):
        from nexus_core.mcp.tools.workflow_tools import update_workflow_tool
...
class TestDeleteWorkflowTool:
    def test_missing_name_returns_error(self, user_dir):
        from nexus_core.mcp.tools.workflow_tools import delete_workflow_tool
...
class TestWorkflowRoundTrip:
    def test_full_lifecycle(self, user_dir, bundled_names_empty, monkeypatch):
        ...
        from nexus_core.mcp.tools.workflow_tools import (
            create_workflow_tool,
            delete_workflow_tool,
            get_workflow_tool,
            list_workflows_tool,
...
class TestPathTraversalProtection:
    ...
    def test_valid_names_still_work(self, user_dir, bundled_names_empty):
        from nexus_core.mcp.tools.workflow_tools import create_workflow_tool, get_workflow_tool
    ...
    def test_validate_name_rejects_empty(self):
        from nexus_core.mcp.tools.workflow_tools import _validate_name
