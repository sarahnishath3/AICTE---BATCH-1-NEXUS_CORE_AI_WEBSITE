...
class TestProgrammaticAPI:
    ...
    def test_import_analyze_presets(self):
        ...
        from nexus_core.cli.presets.analyze_presets import ANALYZE_PRESETS, AnalysisPreset
...
class TestIntegration:
    ...
    def test_unified_cli_subcommands_registered(self):
        ...
        result = subprocess.run(["nexus-core", "--help"], capture_output=True, text=True)
