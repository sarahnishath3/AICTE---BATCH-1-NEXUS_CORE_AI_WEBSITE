...
class TestEpubExtraction(unittest.TestCase):
    ...
    @patch("nexus_core.cli.epub_scraper.epub")
    @patch("nexus_core.cli.epub_scraper.os.path.exists", return_value=True)
    @patch("nexus_core.cli.epub_scraper.os.path.isfile", return_value=True)
    ...
    def test_extract_deps_not_installed(self):
        from nexus_core.cli.epub_scraper import _check_epub_deps

        with patch("nexus_core.cli.epub_scraper.EPUB_AVAILABLE", False):
...
class TestEpubExtractionReal(unittest.TestCase):
    ...
    def setUp(self):
        from nexus_core.cli.epub_scraper import EpubToSkillConverter, EPUB_AVAILABLE
