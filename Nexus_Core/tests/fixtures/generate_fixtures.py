...
def generate_docx():
    ...
    doc.core_properties.subject = "Testing Nexus Core DOCX scraper integration"

    doc.add_heading("Test Word Document", level=1)
    doc.add_paragraph("This is a test document for the Nexus Core Word scraper.")
...
def generate_epub():
    ...
    book.add_author("Nexus Core Test")
    book.add_metadata("DC", "description", "Testing Nexus Core EPUB scraper integration")
...
def _generate_epub_manual():
    ...
    content_opf = (
        ...
        '<dc:creator id="author">Nexus Core Test</dc:creator>'
        "<dc:language>en</dc:language>"
        '<dc:identifier id="book-id">test-epub-001</dc:identifier>'
        "<dc:description>Testing Nexus Core EPUB scraper integration</dc:description>"
        "</metadata>"
        "<manifest>"
