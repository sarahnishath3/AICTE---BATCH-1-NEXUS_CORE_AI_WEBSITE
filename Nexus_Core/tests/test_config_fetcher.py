...
class TestFetchConfigFromApi:
    ...
    @patch("nexus_core.cli.config_fetcher.httpx.Client")
    ...
    def test_normalize_config_name(self, tmp_path):
        ...
        with patch("nexus_core.cli.config_fetcher.httpx.Client") as mock_client_class:
            mock_client = Mock()
            mock_client_class.return_value.__enter__.return_value = mock_client
...
class TestResolveConfigPath:
    ...
    @patch("nexus_core.cli.config_fetcher.fetch_config_from_api")
