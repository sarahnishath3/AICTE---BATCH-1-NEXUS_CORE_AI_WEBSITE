...
from nexus_core.cli.doc_scraper import DocToSkillConverter, load_config, validate_config
...
"""
    ...
    def test_full_llms_txt_workflow(self):
        ...
        with patch("nexus_core.cli.llms_txt_downloader.requests.get") as mock_get:
    ...
    def test_multi_variant_download(self):
        ...
        with (
            patch("nexus_core.cli.llms_txt_detector.requests.head") as mock_head,
            patch("nexus_core.cli.llms_txt_downloader.requests.get") as mock_get,
        ):
            ...
            # Run scraper
            from nexus_core.cli.doc_scraper import DocToSkillConverter as DocumentationScraper
