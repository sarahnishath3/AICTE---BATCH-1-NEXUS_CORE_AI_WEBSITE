...
def _stub_sdk_available(monkeypatch, available=True):
    ...
    monkeypatch.setattr(
        "nexus_core.cli.enhance_command.api_sdk_available",
...
class TestIsRoot:
    def test_returns_bool(self):
        from nexus_core.cli.enhance_command import _is_root
...
class TestPickModeExplicitTarget:
    def test_target_gemini_forces_api(self, monkeypatch):
        ...
        from nexus_core.cli.enhance_command import _pick_mode
...
class TestPickModeSdkFallback:
    ...
    def test_moonshot_key_without_openai_sdk_falls_back_to_local(self, monkeypatch, capsys):
        ...
        from nexus_core.cli import enhance_command
        ...
        monkeypatch.setitem(enhance_command.TARGET_SDK_MODULES, "kimi", "nexus_core_no_such_sdk")
    ...
    def test_api_sdk_available_missing_parent_package(self, monkeypatch):
        ...
        monkeypatch.setitem(
            enhance_command.TARGET_SDK_MODULES, "gemini", "nexus_core_no_such_pkg.sub"
        )
...
class TestPickModeConfigAgent:
    def _patch_config(self, monkeypatch, agent: str | None):
        ...
        monkeypatch.setattr(
            "nexus_core.cli.enhance_command._get_config_default_agent",
            lambda: agent,
        )
...
class TestEnhanceArgumentParsing:
    ...
    def _parse(self, argv, tmp_path):
        ...
        from nexus_core.cli.arguments.enhance import add_enhance_arguments
...
class TestEnhanceCommandMain:
    def test_dry_run_no_ai_call(self, tmp_path):
        ...
        try:
            from nexus_core.cli.enhance_command import main
    ...
    def test_root_api_mode_allowed(self, monkeypatch, tmp_path):
        ...
        monkeypatch.setattr(
            "nexus_core.cli.enhance_command._run_api_mode",
            lambda *_: 0,
        )
...
class TestRunApiModeKeySelection:
    ...
    def _captured_argv(self, monkeypatch, tmp_path, target, env=None):
        ...
        from nexus_core.cli.agent_client import API_PROVIDERS
        from nexus_core.cli.enhance_command import _run_api_mode
...
class TestConfigManagerDefaultAgent:
    def test_get_default_agent_none_by_default(self, tmp_path, monkeypatch):
        from nexus_core.cli.config_manager import ConfigManager
