...
class TestScrapingTools:
    ...
    async def test_scrape_github_basic(self):
        ...
        with patch(
            "nexus_core.cli.skill_converter.get_converter",
...
class TestPackagingTools:
    ...
    async def test_package_skill_basic(self, temp_dirs):
        ...
        with patch("nexus_core.mcp.tools.packaging_tools.run_cli_main") as mock_run:
    ...
    async def test_install_skill_with_config_name(self):
        ...
        with patch("nexus_core.mcp.tools.source_tools.fetch_config_tool") as mock_fetch:
