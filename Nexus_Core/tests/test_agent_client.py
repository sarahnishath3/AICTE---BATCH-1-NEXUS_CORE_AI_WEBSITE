...
from nexus_core.cli.agent_client import (
...
class TestSkillMdEnhancementBudget:
    ...
    def test_adaptor_enhance_requests_16384(self, monkeypatch, tmp_path):
        from nexus_core.cli import agent_client as agent_client_module
        from nexus_core.cli.adaptors.base import SkillAdaptor
...
class TestProviderRegistry:
    ...
    def test_no_keys_returns_none(self, monkeypatch):
        from nexus_core.cli.agent_client import detect_api_target, get_provider_api_keys
    ...
    def test_api_key_map_derived_from_registry(self):
        from nexus_core.cli.agent_client import API_KEY_MAP, API_PROVIDERS
