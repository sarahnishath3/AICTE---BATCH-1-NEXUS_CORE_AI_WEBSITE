...
def _make_sample_video_info():
    ...
    from nexus_core.cli.video_models import (
        TranscriptSource,
        VideoInfo,
        VideoSourceType,
        Chapter,
...
def _make_sample_transcript_segments():
    ...
    from nexus_core.cli.video_models import TranscriptSegment, TranscriptSource
...
class TestVideoModels(unittest.TestCase):
    ...
    def test_video_source_type_enum(self):
        from nexus_core.cli.video_models import VideoSourceType
    ...
    def test_transcript_source_enum(self):
        from nexus_core.cli.video_models import TranscriptSource
    ...
    def test_segment_content_type_enum(self):
        from nexus_core.cli.video_models import SegmentContentType
    ...
    def test_chapter_serialization(self):
        from nexus_core.cli.video_models import Chapter
    ...
    def test_video_segment_serialization(self):
        from nexus_core.cli.video_models import SegmentContentType, VideoSegment
    ...
    def test_video_segment_timestamp_display(self):
        from nexus_core.cli.video_models import VideoSegment
    ...
    def test_video_info_serialization(self):
        ...
        from nexus_core.cli.video_models import VideoInfo
    ...
    def test_video_source_config_validation(self):
        from nexus_core.cli.video_models import VideoSourceConfig
    ...
    def test_video_scraper_result_serialization(self):
        from nexus_core.cli.video_models import VideoScraperResult
    ...
    def test_word_timestamp_serialization(self):
        from nexus_core.cli.video_models import WordTimestamp
    ...
    def test_code_block_serialization(self):
        from nexus_core.cli.video_models import CodeBlock, CodeContext
...
class TestVideoMetadata(unittest.TestCase):
    ...
    def test_extract_video_id_standard_url(self):
        from nexus_core.cli.video_metadata import extract_video_id
    ...
    def test_detect_video_source_type_youtube(self):
        from nexus_core.cli.video_metadata import detect_video_source_type
        from nexus_core.cli.video_models import VideoSourceType
    ...
    def test_extract_local_metadata(self):
        from nexus_core.cli.video_metadata import extract_local_metadata
...
class TestVideoTranscript(unittest.TestCase):
    ...
    def test_parse_srt(self):
        from nexus_core.cli.video_transcript import parse_srt
    ...
    def test_parse_vtt(self):
        from nexus_core.cli.video_transcript import parse_vtt
...
"""
    ...
    def test_whisper_stub_raises(self):
        from nexus_core.cli.video_transcript import transcribe_with_whisper, HAS_WHISPER
    ...
    def test_get_transcript_fallback_to_subtitle(self):
        ...
        from nexus_core.cli.video_transcript import get_transcript
        from nexus_core.cli.video_models import (
            TranscriptSource,
            VideoInfo,
            VideoSourceConfig,
...
class TestVideoSegmenter(unittest.TestCase):
    ...
    def test_segment_by_chapters(self):
        from nexus_core.cli.video_segmenter import segment_by_chapters
    ...
    def test_segment_by_time_window(self):
        from nexus_core.cli.video_segmenter import segment_by_time_window
    ...
    def test_segment_video_uses_chapters(self):
        from nexus_core.cli.video_segmenter import segment_video
        from nexus_core.cli.video_models import VideoSourceConfig
    ...
    def test_segment_video_fallback_to_time_window(self):
        from nexus_core.cli.video_segmenter import segment_video
        from nexus_core.cli.video_models import VideoInfo, VideoSourceConfig, VideoSourceType
    ...
    def test_segment_content_type_classification(self):
        from nexus_core.cli.video_segmenter import _classify_content_type
        from nexus_core.cli.video_models import SegmentContentType
...
class TestVideoSourceDetection(unittest.TestCase):
    ...
    def test_detect_youtube_url(self):
        from nexus_core.cli.source_detector import SourceDetector
    ...
    def test_validate_video_file_exists(self):
        from nexus_core.cli.source_detector import SourceDetector, SourceInfo
...
class TestVideoArguments(unittest.TestCase):
    ...
    def test_video_arguments_dict(self):
        from nexus_core.cli.arguments.video import VIDEO_ARGUMENTS
    ...
    def test_add_video_arguments(self):
        import argparse
        from nexus_core.cli.arguments.video import add_video_arguments
...
class TestVideoToSkillConverter(unittest.TestCase):
    ...
    def test_init_with_url(self):
        from nexus_core.cli.video_scraper import VideoToSkillConverter
    ...
    def test_save_and_load_extracted_data(self):
        ...
        from nexus_core.cli.video_scraper import VideoToSkillConverter
        from nexus_core.cli.video_models import VideoScraperResult, VideoInfo, VideoSourceType
...
class TestVideoVisualStubs(unittest.TestCase):
    ...
    def test_check_visual_dependencies(self):
        from nexus_core.cli.video_visual import check_visual_dependencies
    ...
    def test_detect_scenes_raises_without_deps(self):
        from nexus_core.cli.video_visual import detect_scenes, HAS_OPENCV
    ...
    def test_extract_keyframes_raises_without_deps(self):
        from nexus_core.cli.video_visual import extract_keyframes, HAS_OPENCV
    ...
    def test_classify_frame_raises_without_deps(self):
        from nexus_core.cli.video_visual import classify_frame, HAS_OPENCV
    ...
    def test_extract_text_raises_without_deps(self):
        from nexus_core.cli.video_visual import extract_text_from_frame, HAS_EASYOCR
...
class TestVideoCreateCommandIntegration(unittest.TestCase):
    ...
    def test_create_arguments_include_video(self):
        ...
        from nexus_core.cli.arguments.create import get_source_specific_arguments
...
class TestVideoConfigValidator(unittest.TestCase):
    ...
    def test_video_in_valid_source_types(self):
        from nexus_core.cli.config_validator import ConfigValidator
...
class TestVideoHelperFunctions(unittest.TestCase):
    ...
    def test_sanitize_filename(self):
        from nexus_core.cli.video_scraper import _sanitize_filename
    ...
    def test_format_duration(self):
        from nexus_core.cli.video_scraper import _format_duration
    ...
    def test_format_count(self):
        from nexus_core.cli.video_scraper import _format_count
    ...
    def test_infer_description_from_video(self):
        from nexus_core.cli.video_scraper import infer_description_from_video
...
class TestOCRPreprocessing(unittest.TestCase):
    ...
    def test_get_ocr_params_code_editor(self):
        from nexus_core.cli.video_visual import _get_ocr_params
        from nexus_core.cli.video_models import FrameType
    ...
    def test_preprocess_returns_original_for_other(self):
        from nexus_core.cli.video_visual import _preprocess_frame_for_ocr
        from nexus_core.cli.video_models import FrameType
...
class TestSpatialLayout(unittest.TestCase):
    ...
    def test_cluster_empty_results(self):
        from nexus_core.cli.video_visual import _cluster_ocr_into_lines
        from nexus_core.cli.video_models import FrameType
    ...
    def test_assemble_code_editor_newlines(self):
        from nexus_core.cli.video_visual import _assemble_structured_text
        from nexus_core.cli.video_models import FrameType, OCRRegion
...
class TestTextContinuity(unittest.TestCase):
    ...
    def test_text_similarity_identical(self):
        from nexus_core.cli.video_visual import _text_similarity
    ...
    def test_tracker_creates_new_block(self):
        from nexus_core.cli.video_visual import TextBlockTracker
        from nexus_core.cli.video_models import FrameType
    ...
    def test_extract_code_blocks_filters_short(self):
        from nexus_core.cli.video_visual import _extract_code_blocks, TrackedTextBlock
        from nexus_core.cli.video_models import FrameType
    ...
    def test_extract_code_blocks_maps_context(self):
        from nexus_core.cli.video_visual import _extract_code_blocks, TrackedTextBlock
        from nexus_core.cli.video_models import CodeContext, FrameType
    ...
    def test_extract_visual_data_returns_tuple(self):
        ...
        from nexus_core.cli.video_visual import extract_visual_data, HAS_OPENCV
...
class TestYBucketConsensus(unittest.TestCase):
    ...
    def test_single_frame_single_region(self):
        from nexus_core.cli.video_visual import YBucketConsensusEngine
        from nexus_core.cli.video_models import OCRRegion
...
class TestTextGroupTimeline(unittest.TestCase):
    ...
    def test_timeline_serialization(self):
        from nexus_core.cli.video_models import TextGroup, TextGroupTimeline, FrameType
    ...
    def test_text_group_full_text(self):
        from nexus_core.cli.video_models import TextGroup, FrameType
    ...
    def test_text_group_serialization(self):
        from nexus_core.cli.video_models import TextGroup, TextGroupEdit, FrameType
    ...
    def test_video_info_no_timeline_serialization(self):
        from nexus_core.cli.video_models import VideoInfo, VideoSourceType
...
class TestAudioVisualAlignment(unittest.TestCase):
    ...
    def test_alignment_serialization(self):
        from nexus_core.cli.video_models import AudioVisualAlignment
    ...
    def test_build_audio_visual_alignments(self):
        from nexus_core.cli.video_scraper import _build_audio_visual_alignments
        from nexus_core.cli.video_models import (
            TextGroup,
            TextGroupTimeline,
            TranscriptSegment,
...
class TestDarkThemePreprocessing(unittest.TestCase):
    ...
    def test_detect_theme_dark(self):
        ...
        from nexus_core.cli.video_visual import _detect_theme
...
class TestMultiEngineOCR(unittest.TestCase):
    ...
    def test_tesseract_ocr_returns_correct_format(self):
        ...
        from nexus_core.cli.video_models import FrameType
        from nexus_core.cli.video_visual import _run_tesseract_ocr
    ...
    def test_multi_engine_picks_higher_confidence(self):
        ...
        from nexus_core.cli.video_visual import _pick_better_ocr_result
    ...
    def test_multi_engine_single_engine_fallback(self):
        ...
        from nexus_core.cli.video_visual import _merge_by_y_bucket
...
class TestClaudeVisionOCR(unittest.TestCase):
    ...
    def test_vision_ocr_no_api_key(self):
        ...
        from nexus_core.cli.video_models import FrameType
        from nexus_core.cli.video_visual import _ocr_with_claude_vision
...
class TestRegionDetection(unittest.TestCase):
    ...
    def test_single_panel_no_dividers(self):
        ...
        from nexus_core.cli.video_visual import classify_frame_regions
    ...
    def test_find_code_bbox_merges_regions(self):
        ...
        from nexus_core.cli.video_models import FrameType
        from nexus_core.cli.video_visual import _find_code_bbox
    ...
    def test_crop_code_region(self):
        ...
        from nexus_core.cli.video_visual import _crop_code_region
...
class TestPerPanelOCR(unittest.TestCase):
    ...
    def test_get_code_panels_returns_individual_panels(self):
        ...
        from nexus_core.cli.video_models import FrameType
        from nexus_core.cli.video_visual import _get_code_panels
...
class TestTextGroupPanelId(unittest.TestCase):
    ...
    def test_text_group_panel_id_serialization(self):
        ...
        from nexus_core.cli.video_models import FrameType, TextGroup
...
class TestVideoEnhanceSourceDetection(unittest.TestCase):
    ...
    def test_utils_detect_video_source(self):
        ...
        from nexus_core.cli.utils import read_reference_files
...
class TestVideoEnhancementPrompt(unittest.TestCase):
    ...
    def test_is_video_source_true(self):
        ...
        from nexus_core.cli.enhance_skill import SkillEnhancer
...
class TestVideoWorkflowAutoInjection(unittest.TestCase):
    ...
    def test_video_tutorial_yaml_exists(self):
        ...
        try:
            pkg = importlib_files("nexus_core.workflows")
...
class TestTimeClipping(unittest.TestCase):
    ...
    def test_parse_time_seconds_integer(self):
        from nexus_core.cli.video_scraper import parse_time_to_seconds
    ...
    def test_create_arguments_include_start_end_time(self):
        from nexus_core.cli.arguments.create import VIDEO_ARGUMENTS
    ...
    def test_transcript_clip_filters_segments(self):
        ...
        from nexus_core.cli.video_models import TranscriptSegment
...
class TestCleanOcrLine(unittest.TestCase):
    ...
    def test_strips_leading_line_numbers(self):
        from nexus_core.cli.video_visual import _clean_ocr_line
...
class TestFixIntraLineDuplication(unittest.TestCase):
    ...
    def test_fixes_simple_duplication(self):
        from nexus_core.cli.video_visual import _fix_intra_line_duplication
...
class TestIsLikelyCode(unittest.TestCase):
    ...
    def test_true_for_real_code(self):
        from nexus_core.cli.video_scraper import _is_likely_code
...
class TestTextGroupLanguageDetection(unittest.TestCase):
    ...
    def test_groups_get_language_detected(self):
        ...
        with patch.dict("sys.modules", {"nexus_core.cli.language_detector": mock_module}):
            groups = tracker.get_text_groups()
...
class TestFuzzyWordMatch(unittest.TestCase):
    ...
    def test_exact_match(self):
        from nexus_core.cli.video_visual import _fuzzy_word_match
