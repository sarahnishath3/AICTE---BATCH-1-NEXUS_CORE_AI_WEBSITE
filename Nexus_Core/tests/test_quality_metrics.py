...
from nexus_core.cli.quality_metrics import QualityAnalyzer, MetricLevel
...
def test_main_report_only_exits_zero(minimal_skill_dir):
    ...
    from nexus_core.cli.quality_metrics import main
...
def test_json_default_serializes_enum_value():
    from nexus_core.cli.quality_metrics import _json_default
