...
from nexus_core.cli.enhance_skill_local import LocalSkillEnhancer, detect_terminal_app
...
class TestDetectTerminalApp(unittest.TestCase):
    ...
    @patch("nexus_core.cli.enhance_skill_local.sys.platform", "darwin")
...
class TestTerminalMapCompleteness(unittest.TestCase):
    ...
    def test_terminal_map_has_all_documented_terminals(self):
        ...
        from nexus_core.cli.enhance_skill_local import detect_terminal_app
