...
from nexus_core.cli.upload_skill import upload_skill_api
...
class TestUploadSkillCLI(unittest.TestCase):
    ...
    def test_cli_help_output(self):
        """Test that nexus-core upload --help works"""
        import subprocess

        try:
            result = subprocess.run(
                ["nexus-core", "upload", "--help"], capture_output=True, text=True, timeout=5
            )
    ...
    def test_cli_executes_without_errors(self):
        """Test that nexus-core-upload entry point works"""
        import subprocess
        ...
        try:
            ...
            self.skipTest("nexus-core-upload command not installed")
