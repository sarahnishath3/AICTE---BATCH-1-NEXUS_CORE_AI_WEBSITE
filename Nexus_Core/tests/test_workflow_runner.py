...
from nexus_core.cli.workflow_runner import collect_workflow_vars, run_workflows
...
class TestBundledPresetsLoad:
    ...
    def test_bundled_preset_loads(self, preset_name):
        from nexus_core.cli.enhancement_workflow import WorkflowEngine
    ...
    def test_list_bundled_workflows_returns_all(self):
        from nexus_core.cli.enhancement_workflow import list_bundled_workflows
    ...
    def test_list_user_workflows_empty_when_no_user_dir(self, tmp_path, monkeypatch):
        """list_user_workflows returns [] when ~/.config/nexus-core/workflows/ does not exist."""
        from nexus_core.cli import enhancement_workflow as ew_mod
        import pathlib
