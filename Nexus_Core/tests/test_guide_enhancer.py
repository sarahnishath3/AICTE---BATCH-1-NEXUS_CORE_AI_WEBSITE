...
from nexus_core.cli.guide_enhancer import (
    GuideEnhancer,
    PrerequisiteItem,
    StepEnhancement,
    TroubleshootingItem,
...
class TestGuideEnhancerModeDetection:
    ...
    def test_auto_mode_with_api_key(self):
        ...
        with (
            ...
            patch("nexus_core.cli.guide_enhancer.ANTHROPIC_AVAILABLE", True),
            patch("nexus_core.cli.guide_enhancer.anthropic", create=True) as mock_anthropic,
        ):
...
class TestNoEnhancerNameCollisions:
    ...
    def test_unified_enhancer_defines_no_colliding_names(self):
        import nexus_core.cli.unified_enhancer as ue
    ...
    def test_canonical_classes_importable(self):
        from nexus_core.cli.ai_enhancer import PatternEnhancer, TestExampleEnhancer  # noqa: F401
        from nexus_core.cli.guide_enhancer import GuideEnhancer  # noqa: F401
