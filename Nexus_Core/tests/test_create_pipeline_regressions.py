...
class TestSkipScrapePromotedToConverter:
    ...
    def _execute_with_stub(self, args):
        ...
        cmd = CreateCommand(args)
        with (
            patch("nexus_core.cli.create_command.get_converter", return_value=stub),
...
class TestUnifiedWorkflowsRunOnce:
    ...
    def test_fallback_disabled_skips_context_workflows(self):
        ...
        with (
            patch(
                "nexus_core.cli.execution_context.ExecutionContext.get",
                return_value=mock_ctx,
            ),
            patch("nexus_core.cli.enhancement_workflow.WorkflowEngine") as MockEngine,
        ):
    ...
    def test_fallback_enabled_still_runs_context_workflows(self):
        ...
        with (
            ...
            patch(
                "nexus_core.cli.enhancement_workflow.WorkflowEngine",
    ...
    def test_create_disables_fallback_for_config_source(self):
        ...
        with patch("nexus_core.cli.workflow_runner.run_workflows") as rw:
            cmd._run_workflows()
