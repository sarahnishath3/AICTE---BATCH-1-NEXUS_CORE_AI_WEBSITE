...
class TestPineconeAdaptor:
    ...
    def test_import(self):
        ...
        from nexus_core.cli.adaptors.pinecone_adaptor import PineconeAdaptor
    ...
    def test_registered_in_factory(self):
        ...
        from nexus_core.cli.adaptors import ADAPTORS
...
class TestWeaviateUploadReturnKeys:
    ...
    def test_weaviate_upload_success_has_url_key(self, sample_skill_dir, tmp_path, monkeypatch):
        ...
        from nexus_core.cli.adaptors.weaviate import WeaviateAdaptor
...
class TestDocVersionCLIFlag:
    ...
    def test_common_arguments_has_doc_version(self):
        ...
        from nexus_core.cli.arguments.common import COMMON_ARGUMENTS
    ...
    def test_create_arguments_has_doc_version(self):
        ...
        from nexus_core.cli.arguments.create import UNIVERSAL_ARGUMENTS
    ...
    def test_doc_version_flag_parsed(self):
        ...
        import argparse
        from nexus_core.cli.arguments.common import add_common_arguments
