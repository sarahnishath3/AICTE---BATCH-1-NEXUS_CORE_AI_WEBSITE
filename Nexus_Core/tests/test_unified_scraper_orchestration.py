...
class TestScrapeDocumentation:
    ...
    def test_scrape_documentation_called_directly(self, tmp_path):
        ...
        with patch("nexus_core.cli.doc_scraper.scrape_documentation") as mock_scrape:
    ...
    def test_llms_txt_url_forwarded_to_doc_config(self, tmp_path):
        ...
        with patch("nexus_core.cli.doc_scraper.scrape_documentation", side_effect=fake_scrape):
            scraper._scrape_documentation(source)
...
class TestScrapeGithub:
    ...
    def _mock_github_scraper(self, monkeypatch, github_data=None):
        ...
        monkeypatch.setattr(
            "nexus_core.cli.github_scraper.GitHubScraper",
            mock_scraper_cls,
        )
    ...
    def test_github_scraper_instantiated_with_repo(self, tmp_path, monkeypatch):
        ...
        with (
            patch("nexus_core.cli.unified_scraper.json.dump"),
            patch("nexus_core.cli.unified_scraper.json.dumps", return_value="{}"),
...
class TestScrapePdf:
    ...
    def _mock_pdf_converter(self, monkeypatch, tmp_path, pages=None):
        ...
        monkeypatch.setattr(
            "nexus_core.cli.pdf_scraper.PDFToSkillConverter",
            mock_cls,
        )
    ...
    def test_pdf_converter_instantiated_with_path(self, tmp_path, monkeypatch):
        ...
        with patch("nexus_core.cli.unified_scraper.shutil.copy"):
...
class TestScrapeWithConverterEngine:
    ...
    def _mock_pptx_converter(self, monkeypatch, tmp_path, slides=None):
        ...
        monkeypatch.setattr("nexus_core.cli.pptx_scraper.PptxToSkillConverter", mock_cls)
        ...
        monkeypatch.setattr("nexus_core.cli.pptx_scraper._check_pptx_deps", lambda: None)
        return mock_cls, mock_instance
    ...
    def test_unknown_source_type_warns_and_continues(self, monkeypatch, caplog):
        ...
        with caplog.at_level(logging.WARNING, logger="nexus_core.cli.unified_scraper"):
...
class TestScrapeLocal:
    ...
    def test_source_counter_incremented(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "nexus_core.cli.codebase_scraper.analyze_codebase",
            MagicMock(),
        )
...
class TestRunOrchestration:
    ...
    def test_four_phases_called(self):
        ...
        with patch("nexus_core.cli.unified_scraper.run_workflows", create=True):
            scraper.run()
    ...
    def test_workflow_not_called_without_args_and_no_json_workflows(self):
        ...
        with patch("nexus_core.cli.unified_scraper.run_workflows", create=True) as mock_wf:
    ...
    def test_workflow_called_when_args_provided(self):
        ...
        with patch("nexus_core.cli.workflow_runner.run_workflows") as mock_wf:
    ...
    def test_workflow_called_for_json_config_workflows(self):
        ...
        import nexus_core.cli.unified_scraper as us_mod
        import nexus_core.cli.workflow_runner as wr_mod
