...
from nexus_core.cli.config_validator import ConfigValidator, validate_config
from nexus_core.cli.conflict_detector import Conflict, ConflictDetector
from nexus_core.cli.merge_sources import RuleBasedMerger
...
class TestWorkflowJsonConfig:
    ...
    def test_json_workflows_merged_when_args_none(self, tmp_path, monkeypatch):
        ...
        monkeypatch.setattr(
            "nexus_core.cli.workflow_runner.run_workflows", fake_run_workflows, raising=False
        )
        import nexus_core.cli.unified_scraper as us_module
