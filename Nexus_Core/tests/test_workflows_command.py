...
# other tests (e.g. test_swift_detection clears nexus_core.cli.*), because
# we hold a reference to the original module object at collection time.
import nexus_core.cli.workflows_command as _wf_cmd
...
class TestMain:
    def test_main_no_action_exits_0(self):
        from nexus_core.cli.workflows_command import main
