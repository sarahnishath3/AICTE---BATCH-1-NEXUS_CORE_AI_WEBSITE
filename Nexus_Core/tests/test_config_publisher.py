...
class TestPublishErrors:
    ...
    def test_publish_missing_token(self, tmp_path):
        ...
        with (
            patch("nexus_core.services.source_manager.SourceManager", return_value=mock_manager),
            patch("nexus_core.cli.config_validator.validate_config", return_value=None),
    ...
    def test_publish_twice_reuses_cache(self, tmp_path):
        ...
        def _publish(name):
            ...
            with (
                patch.dict(os.environ, {"DUMMY_TOKEN": "x"}),
                patch(
                    "nexus_core.services.source_manager.SourceManager",
