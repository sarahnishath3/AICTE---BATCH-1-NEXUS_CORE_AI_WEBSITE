...
class TestBootstrapSkillScript:
    ...
    def test_header_has_required_sections(self, project_root):
        ...
        assert "pip install nexus-core" in content, "Header must have pip install instruction"

        # Must have commands table
        assert "## Commands" in content, "Header must have Commands section"
        assert "nexus-core create" in content, "Header must mention create command"
    ...
    def test_header_has_yaml_frontmatter(self, project_root):
        ...
        assert "name: nexus-core" in content, "Header must have skill name"
    ...
    def test_bootstrap_script_runs(self, project_root):
        ...
        # Check outputs exist (directory named 'nexus-core' for Claude Code)
        output_dir = project_root / "output" / "nexus-core"
        ...
        assert "pip install nexus-core" in content, "SKILL.md should have install instructions"
