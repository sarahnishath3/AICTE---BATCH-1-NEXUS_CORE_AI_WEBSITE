...
from nexus_core.cli.github_fetcher import (
    CodeStream,
    DocsStream,
...
from nexus_core.cli.merge_sources import RuleBasedMerger, categorize_issues_by_topic
from nexus_core.cli.unified_codebase_analyzer import (
    AnalysisResult,
...
"""
    ...
    def test_scenario_1_unified_analyzer_github(self, mock_github_repo, mock_github_api_data):
        ...
        with (
            ...
            patch(
                "nexus_core.cli.unified_codebase_analyzer.UnifiedCodebaseAnalyzer.c3x_analysis"
            ) as mock_c3x,
        ):
