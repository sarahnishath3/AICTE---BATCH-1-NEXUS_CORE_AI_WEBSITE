...
from nexus_core.benchmark import (
    Benchmark,
    BenchmarkResult,
    BenchmarkRunner,
    BenchmarkReport,
...
from nexus_core.benchmark.models import TimingResult, MemoryUsage
...
class TestBenchmarkRunner:
    ...
    def test_compare_benchmarks(self, tmp_path):
        ...
        # Compare
        from nexus_core.benchmark.models import ComparisonReport
