...
from nexus_core.cli.pattern_recognizer import (
    FactoryDetector,
    LanguageAdapter,
    ObserverDetector,
    PatternInstance,
...
class TestBaseClassMatching(unittest.TestCase):
    ...
    def test_base_root_normalizes(self):
        from nexus_core.cli.pattern_recognizer import _base_root
    ...
    def test_matches_base_handles_generics_and_qualifiers(self):
        from nexus_core.cli.pattern_recognizer import _matches_base
