...
from nexus_core.cli.unified_codebase_analyzer import AnalysisResult, UnifiedCodebaseAnalyzer
...
class TestGitHubAnalysis:
    ...
    @patch("nexus_core.cli.unified_codebase_analyzer.GitHubThreeStreamFetcher")
